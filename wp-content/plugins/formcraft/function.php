...
function formcraft_update() {
    ...
    {
        $html = formcraft_replace_comments('<!--START-->', '<!--END-->', $html, '<!--STARTPOWERED--><a class="no-key-link" href="http://formcrafts.com?pw=pw2" target="_blank" style="display: inline-block !important; visibility: visible !important"> <span> </span> </a><!--ENDPOWERED-->');
    }
    if ( is_user_logged_in() )
    {
