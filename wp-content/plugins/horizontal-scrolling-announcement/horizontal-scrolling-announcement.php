...
function HSA_activation() 
{
	...
	add_option('hsa_capability', "announcements");
}
...
function HSA_add_to_menu() 
{
	...
	//announcements(Administrator), edit_posts(Administrator/Editor/Author/Contributor), edit_others_pages(Administrator/Editor)
	if($hsa_capability == "")
	{
		$hsa_capability = "announcements";
	}
	if($hsa_capability <> "announcements" && $hsa_capability <> "edit_posts" && $hsa_capability <> "edit_others_pages")
	{
		$hsa_capability = "announcements";
	}
