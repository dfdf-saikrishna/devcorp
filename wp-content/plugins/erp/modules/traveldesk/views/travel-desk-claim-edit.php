                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div id="fileDiv">
					  <?php $imdir = WPERP_COMPANY_DOWNLOADS .'/erp/modules/company/upload/'. $compid .'/bills_tickets/';							
							 ?>
                        <?php if($rows->TDC_Filename){?>
                        <a style="font-size:12px;" href="<?php echo $imdir . $rows->TDC_Filename; ?>">download current</a> <br />
                        <?php } ?>
...
function upload1()
{
	//onchange="picval(this.id)"
	bkp=document.getElementById('fileDiv').innerHTML;
	
	document.getElementById('fileDiv').innerHTML='<input type="file" name="fileattach" id="fileattach">&nbsp;<a href="javascript:cancelImg1()">Cancel</a>';
}
function cancelImg1()
{
