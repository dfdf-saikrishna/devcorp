              ...
              <div class="inside">
                      ...
                      <table class="wp-list-table widefat striped admins">
                        <tr>
						  ...
						  <?php echo $empdetails->EMP_Code?> (<?php echo $empdetails->EG_Name?>)
                          <?php } else {
							  echo "__";
						  } ?></td>
                          ...
                          <td width="5%">:</td>
                          <td width="25%">
						  <?php if(!empty($empdetails)){ echo stripslashes($empdetails->COM_Name); 
						  }else{
							  echo "__";
						  }?></td>
                        </tr>
                        <tr>
                          ...
                          <td width="5%">:</td>
                          <td width="25%">
						  <?php if(!empty($empdetails)){ echo $empdetails->EMP_Name; 
						  } else{ echo "__"; } ?></td>
                          <td width="20%">Reporting Manager Code</td>
                          <td width="5%">:</td>
                          <td width="25%">
						   <?php if(!empty($empdetails)){
						  echo $empdetails->EMP_Reprtnmngrcode; 
						   }else{ echo "__"; } ?>
						  </td>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td>
						   <?php if(!empty($empdetails)){ echo $empdetails->DES_Name; 
							}else{ echo "__"; } ?>
						  </td>
                          ...
                          <td>:</td>
                          <td><?php  if(!empty($empdetails)){
						  echo $repmngname->EMP_Name;}else{ echo "__"; } ?></td>
                        </tr>
                        <tr>
                          <td width="20%">Employee Department</td>
                          <td width="5%">:</td>
                          <td width="25%"><?php  if(!empty($empdetails)){
							  echo $empdetails->DEP_Name; }else{ echo "__"; } ?></td>
                        </tr>
                      </table>
