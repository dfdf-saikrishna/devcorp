...
<div class="payment">
    ...
    <div class="postbox">
		...
		<?php
	            $tdbaId = $rows->TDBA_Id;
	            $bank_details = $wpdb->get_row("SELECT TDBA_AccountNumber FROM travel_desk_bank_account WHERE TDBA_Id='".$claimsview->TDBA_Id."'");
                ?>
		<div class="col-md-3 col-sm-3 col-lg-3 "><p class="h3"><?php _e('Claim Details', 'employee'); ?></p><span><?php echo date('d F Y', strtotime($claimsview->TDC_Date)) ?></span></div>
		
		<div class="col-md-3 col-sm-3 col-lg-3 "><p><table><tbody><tr><td> Reference# </td> <td><input class="form-control input-sm" id="inputsm" value="<?php echo $claimsview->TDC_ReferenceNo ?>" type="text" disabled></td></tr></tbody></table></p></div>
		
		<div class="col-md-3 col-sm-3 col-lg-3 "><p><table><tbody><tr><td> Invoice# </td> <td><input class="form-control input-sm" id="inputsm" type="text" value="<?php echo $claimsview->TDC_InvoiceNo ?>" disabled></td></tr></tbody></table></p></div>
...
$imdir = WPERP_COMPANY_DOWNLOADS .'/company/upload/'. $cmpid .'/bills_tickets/';	
		...
		if(!empty($selrdcs->BA_Id))	{
				...
				<div class="firstbx">
				<p class="padding10">&nbsp;<?php echo stripslashes($claimsview->TDC_Remarks) ?></p>
		        </div>
		
		</div>
		<?php
        if ($claimsview->TDC_Status == 1 && $claimsview->TDC_Level == 2) {
        ?>
	...
	<tr><td><p><button name="accTdClaimed" id="accTdClaimed" class="button button-primary"  type="submit">Submit</button></p></td> <td><p>&nbsp;&nbsp;</p></td> <td><p><button type="reset" class="button erp-button-danger" >Cancel</button></p></td></tr>
			...
			<!-- update form -->
                ...
                <div class="col-md-4 col-sm-4">
		        <div >
	                <?php if ($claimsview->TDC_Level == 1 || $claimsview->TDC_Level == 3): ?>
			...
			<tr><td><p> Service Charge </p></td> <td><p>&nbsp;:&nbsp;</p></td> <td><p><?php echo $claimsview->TDC_ServiceCharges; ?></p></td></tr>
			<?php
		...
		<?php  $fileurl = "/erp/modules/company/upload/" . $compid . "/bills_tickets/" . $claimsview->TDC_Filename; ?>
	    ...
	    <input type="hidden" value="<?php echo $tdcid; ?>" name="tdcid" id="tdcid" >
            ...
            <?php if ($rows->TDC_Level == 1 || $rows->TDC_Level == 3) { ?>
                <div id="my_centered_buttons" class="traveldeskactions">
                    <button type="submit" name="buttontdclaimApproval" id="buttontdclaimApproval" class="button button-primary">Approve</button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="submit" name="buttontdclaimRejection" id="buttontdclaimRejection" class="button erp-button-danger">Reject</button>
                </div>
            </div>
            <?php
        }
