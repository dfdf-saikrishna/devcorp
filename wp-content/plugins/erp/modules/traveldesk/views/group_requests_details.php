                        ...
                        <div id="bookingStatusContainer<?php echo $j; ?>">
                          <?php 
							...
							if($selrdbs->BA_Id == 2 /* || $selrdbs->BA_Id == 3  || $selrdbs->BA_Id ==4 || $selrdbs->BA_Id ==5*/){
								...
								$imdir= WPERP_COMPANY_DOWNLOADS . "/upload/$compid/bills_tickets/";
								...
								foreach($seldocs as $docs){
									...
									$doc.='<b>Uploaded File no. '.$f.': </b> <a href="'.$imdir.$docs->BD_Filename.'" download="bills_tickets" class="btn btn-link">download</a><br>';
