 ...
 * @return void
 */
function travelcompany_on_delete( $user_id, $hard = 0 ) {
    global $wpdb;
 ...
 */
function travelcompany_insert( $args = array() ) {
    global $wpdb;
    $defaults = array(
        //'user_email'      => '',
        'travel_desk'        => array(
    ...
    $userdata = array(
        'user_login'   => $data['travel_desk']['travelcomname'],
        'user_email'   => $data['travel_desk']['travelcomemail'],
        'first_name'   => $data['travel_desk']['travelcomname'],
        'display_name' => $data['travel_desk']['travelcomname'],     
    );

    // if user id exists, do an update
    $user_id = isset( $data['travel_desk']['user_id'] ) ? intval( $data['travel_desk']['user_id'] ) : 0;
    $update  = false;
    ...
    $company_data = array(
	    //'user_id'  => $user_id,
            //'COM_Id'   => '55',
            'TD_Username'   => $data['travel_desk']['travelcomname'],
            'TD_Email'   => $data['travel_desk']['travelcomemail'],
 ...
 */
function count_travelcompaniesadmin() {
 ...
 * @return array
 */
function erp_hr_travelcompanyadmin_get_status_count() {
    global $wpdb;
 ...
 */
function erp_travelcompanyadmin_count_trashed_employees() {
    $employee = new \WeDevs\ERP\HRM\Models\Employee();
 ...
 * @return void
 */
function erp_travelcompanyadmin_restore( $employee_ids ) {
 ...
 * @return void
 */
function travelcompanyadmin_delete( $employee_ids, $hard = false ) {
 ...
 */
function erp_travelcompanyadmin_get_todays_birthday() {
 ...
 */
function erp_travelcompanyadmin_get_next_seven_days_birthday() {
 ...
 */
function erp_travelcompanyadmin_get_employees_dropdown_raw( $exclude = null ) {
 ...
 */
function erp_travelcompanyadmin_get_employees_dropdown( $selected = '' ) {
 ...
 */
function erp_travelcompanyadmin_get_employee_statuses() {
    $statuses = array(
 ...
 * @return array the employee statuses
 */
function erp_travelcompanyadmin_get_employee_statuses_icons( $selected = NULL ) {
 ...
 * @return array the employee statuses
 */
function erp_travelcompanyadmin_get_employee_types() {
    $types = array(
 ...
 */
function erp_travelcompanyadmin_get_employee_sources() {
    $sources = array(
 ...
 */
function erp_travelcompanyadmin_get_marital_statuses( $select_text = null ) {
 ...
 */
function erp_travelcompanyadmin_get_terminate_type( $selected = NULL ) {
 ...
 */
function erp_travelcompanyadmin_get_terminate_reason( $selected = NULL ) {
 ...
 * @return array all the reason
 */
function erp_travelcompanyadmin_get_terminate_rehire_options( $selected = NULL ) {
 ...
 */
function erp_travelcompanyadmin_employee_terminate( $data ) {
 ...
 * @return array all the statuses
 */
function erp_travelcompanyadmin_get_genders( $select_text = null ) {
 ...
 * @return array all the statuses
 */
function erp_travelcompanyadmin_get_pay_type() {
    $types = array(
 ...
 * @return array all the statuses
 */
function erp_travelcompanyadmin_get_pay_change_reasons() {
    $reasons = array(
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_add_history( $args = array() ) {
    global $wpdb;
 ...
 * @return bool
 */
function erp_travelcompanyadmin_employee_remove_history( $history_id ) {
    global $wpdb;
 ...
 */
function erp_travelcompanyadmin_url_single_employee( $employee_id, $tab = null ) {
    if ( $tab ) {
        $tab = '&tab=' . $tab;
    }
 ...
 * @return array
 */
function erp_travelcompanyadmin_employee_dashboard_announcement( $user_id ) {
    global $wpdb;
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_general( $employee ) {
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_job( $employee ) {
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_leave( $employee ) {
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_notes( $employee ) {
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_performance( $employee ) {
 ...
 * @return void
 */
function erp_travelcompanyadmin_employee_single_tab_permission( $employee ) {
