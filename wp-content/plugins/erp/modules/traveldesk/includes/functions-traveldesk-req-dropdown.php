...
function cancelBookingstat(buttonId)
{
	...
	document.getElementById(txtamnt).style.display='none';
	...
	switch(bookingActionval){
		...
		//document.getElementById(fileattach).value=null;
			...
			//document.getElementById(cancelButton).style.display='inline';
                        document.getElementById('buttonShow'+flid).style.display='block';
                        var div = document.getElementById('buttonShow'+flid);
                        div.innerHTML = div.innerHTML = '<input type="hidden" name="rdid'+flid+'" id="rdid'+flid+'" value="'+flid+'" /><input type="hidden" name="type'+flid+'" id="type" value="1" /><input type="text" placeholder="Booked Amount" class="form-control"  name="txtAmount'+flid+'"  id="txtAmount'+flid+'" /><input type="file" multiple="true" name="fileattach'+flid+'[]" id="fileattach'+flid+'[]" onchange="return Validate(this.id);"><button name="buttonUpdateStatus" id="buttonUpdateStatus'+flid+'" value="'+flid+'" padding-bottom:20px;" type="submit" class="button button-primary">Update</button><button name="buttonCancel" id="buttonCancel'+flid+'" value="'+flid+'" padding-bottom:20px;" onclick="cancelBookingstat(this.value)" type="button" class="button erp-button-danger">Cancel</button>';
		...
		//document.getElementById(ticketdiv).style.display='none';
                //document.getElementById(bookingbutton).style.display='none';
		//document.getElementById(cancelButton).style.display='none';
              //  document.getElementById('buttonShow'+flid).style.display='none';
                if(bookingActionval){
				var div = document.getElementById('buttonShow'+flid);
				div.innerHTML = div.innerHTML = '<input type="hidden" name="rdid'+flid+'" id="rdid'+flid+'" value="'+flid+'" /><input type="hidden" name="type'+flid+'" id="type" value="1" /><input type="text" placeholder="Booked Amount" class="form-control" name="txtAmount'+flid+'"  id="txtAmount'+flid+'" /><input type="file" multiple="true" name="fileattach'+flid+'[]" id="fileattach'+flid+'[]" onchange="return Validate(this.id);"><button name="buttonUpdateStatus" id="buttonUpdateStatus'+flid+'" value="'+flid+'" padding-bottom:20px;" type="submit" class="button-primary">Update</button><button name="buttonCancel" id="buttonCancel'+flid+'" value="'+flid+'" padding-bottom:20px;" onclick="cancelBookingstat(this.value)" type="button" class="button erp-button-danger">Cancel</button>';
                document.getElementById('buttonShow'+flid).style.display='block';
                document.getElementById('txtAmount'+flid).style.display='none';
                document.getElementById('fileattach'+flid+'[]').style.display='none';
                //div.innerHTML = div.innerHTML = '<button name="buttonUpdateStatus" id="buttonUpdateStatus'+flid+'" value="'+flid+'" padding-bottom:20px;" type="submit" class="button-primary">Update</button><button name="buttonCancel" id="buttonCancel'+flid+'" value="'+flid+'" padding-bottom:20px;" onclick="cancelBookingstat(this.value)" type="button" class="button erp-button-danger">Cancel</button>';
...
function showHideBookingta(flid, bookingActionval)
{
	//alert(flid);
...
function showHideBookingcustom(flid, bookingActionval)
{
	//alert(flid);
...
{	
	...
	document.getElementById(canAmnt).style.display='none';
	document.getElementById(fileCanAttach).value=null;
	document.getElementById(fileCanAttach).style.display='none';
