...
<div class="postbox">
   <div class="inside">
      <div class="wrap pre-travel-request erp request" id="wp-erp">
         <h2><?php _e( 'Booking Request', 'employee' ); ?></h2>
         <!--<code class="description">ADD Request</code>-->
            ...
            <!-- Employee Details -->
            <form role="form" parsley-validate id="bookingRequest" name="bookingRequest" action="#" method="post" enctype="multipart/form-data">
            <div class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-2 col-lg-2" for="email">&nbsp;&nbsp;Travel Plan:</label>
                <div class="col-sm-4 col-lg-3">
                  <input type="radio" name="radTrvPlan" class="travelplan" id="radTrvPlan" value="domestic" checked="checked">
                  Domestic
                  <input type="radio" name="radTrvPlan" class="travelplan" id="radTrvPlan" value="international" >
                  International </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 col-lg-2" for="email">&nbsp;&nbsp;Employee Code:</label>
                <div class="col-sm-4 col-lg-3">
                  <input type="text" class="form-control"  name="empcode" id="empcode" maxlength="30" required>
                  <small class="text-danger">Please dont add employee prefix</small> </div>
                <div class="col-sm-4 col-lg-3">
                  <button type="button" name="buttonFindEmployee" id="buttonFindEmployee" class="btn btn-primary">Find Details</button>
                </div>
              </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Mobile</td>
                          <td width="5%">:</td>
                          <td id="employeeMobile"></td>
                        </tr>
                        <tr>
                          <td>DOB</td>
                          <td width="5%">:</td>
                          <td id="employeeDob"></td>
                        </tr>
                        <tr>
                          <td>Gender</td>
                          <td width="5%">:</td>
              ...
              <div id="employeeDetailsNew" style="display:none;" >
                <div class="form-group">
                  <label class="control-label col-sm-2" >Employee Name:</label>
                  <div class="col-lg-6">
                    <input type="text" class="form-control newEmp" id="txtEmpName" name="txtEmpName" maxlength="50" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" >Email:</label>
                  <div class="col-lg-6">
                    <input type="text" class="form-control newEmp" id="txtEmail" name="txtEmail" parsley-type="email" maxlength="50" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" >Mobile:</label>
                  <div class="col-lg-6">
                    <input type="text" class="form-control newEmp" id="txtMobile" name="txtMobile" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" >DOB:</label>
                  <div class="col-lg-6">
                    <input type="text" class="form-control erp-ncorp-date-field newEmp" id="txtDob" name="txtDob" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" >Gender:</label>
                  <div class="col-lg-6">
                    <input type="radio"   id="radGender" name="radGender"  value="male" checked="checked">
                    Male
                    <input type="radio"   id="radGender" name="radGender"  value="female" >
                    Female </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" >Meal Preference:</label>
                  <div class="col-lg-6">
                    <input type="radio"   id="radMealPrf" name="radMealPrf"  value="vegetarian" checked="checked">
                    vegetarian
                    <input type="radio"   id="radMealPrf" name="radMealPrf"  value="non-vegetarian" >
                    non-vegetarian </div>
                </div>
              </div>
              <div class="clearfix"></div>
              <p>&nbsp;</p>
              <div id="empPassportDetails" style="display:none;">
                <div class="col-lg-8">
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
                      ...
                      <tbody>
					    <tr>
                          ...
                          <td width="5%">:</td>
                          <td id="empPassportFrontView" width=""></td>
                        </tr>
						<tr>
                          <td width="30%">Passport Back View</td>
                          <td width="5%">:</td>
                          <td id="empPassportBackView" width=""></td>
                        </tr>
                        <tr>
                          <td width="30%">Passport Number</td>
                          <td width="5%">:</td>
                          <td id="empPassportNo" width=""></td>
                        </tr>
                        <tr>
                          <td>Issued Country</td>
                          <td width="5%">:</td>
                          <td id="empIssuedCountry"></td>
                        </tr>
                        <tr>
                          <td>Issued Place</td>
                          <td width="5%">:</td>
                          <td id="empIssuedPlace"></td>
                        </tr>
                        <tr>
                          <td>Issued Date</td>
                          <td width="5%">:</td>
                          <td id="empIssuedDate"></td>
                        </tr>
                        <tr>
                          <td>Expiry Date</td>
                          <td width="5%">:</td>
                          <td id="empExpiryDate"></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div id="empPassprtDetailsNew" style="display:none;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <input type="text" name="txtPassportno" id="txtPassportno" class="form-control pptclass" required="true" maxlength="30"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" title="Issued Country">Issued Country</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtIssuedCountry" id="txtIssuedCountry" class="form-control pptclass" required="true" maxlength="30"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Issued Place</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtIssuedplc" id="txtIssuedplc" class="form-control pptclass" required="true" maxlength="30"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Issued Date</label>
                  <div class="col-lg-4">
                    <input type="text" readonly="readonly" name="txtIssuedDAte" id="txtIssuedDAte" class="form-control erp-ncorp-date-field pptclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Expiry Date</label>
                  <div class="col-lg-4">
                    <input name="txtExpiryDate" id="txtExpiryDate" readonly="readonly" required="true" class="form-control pretraveldate expirydate pptclass"  />
                  </div>
                </div>
              </div>
              <div class="clearfix"></div>
              <p>&nbsp;</p>
              <div id="empVisaDetailsNew" style="display:none;">
                <div class="page-header col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <input type="text" name="txtVisa" id="txtVisa" class="form-control visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Country</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtCountry" id="txtCountry" class="form-control visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Issued At</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtIssuedAt" id="txtIssuedAt" class="form-control visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Type of Visa</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtTypeofvisa" id="txtTypeofvisa" class="form-control visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">No. of Entries</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtNoofEntries" id="txtNoofEntries" class="form-control visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Date of Issue</label>
                  <div class="col-lg-4">
                    <input type="text" readonly="true" name="txtDateofIssue" id="txtDateofIssue" class="form-control erp-ncorp-date-field visaclass" required="true"/>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Expiry Date</label>
                  <div class="col-lg-4">
                    <input type="text" name="txtDateofExpiry" id="txtDateofExpiry" class=" form-control pretraveldate visaclass" readonly="true" required="true" onkeydown="return false;"/>
                  </div>
                </div>
              </div>
              </div>
 	 ...
 	 <div class=" col-md-3 col-lg-3 col-sm-12 col-xs-12 ">
         ...
         <td  class="text-center"><label><input class="" name="txtCost[]" id="txtCost1" autocomplete="off" onkeyup="valCostPre(this.value,1,1);" onchange="valCostPre(this.value,1);" type="text" placeholder="0"></label><span class="red" id="show-exceed1"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-bus eicon exceed3" aria-hidden="true"></i></label></td>
         <td  class="text-center"><label><input class="" name="txtCost[]" id="txtCost3" autocomplete="off" onkeyup="valCostPre(this.value,3,2);" onchange="valCostPre(this.value,3);" type="text" placeholder="0"></label><span class="red" id="show-exceed3"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-hospital-o eicon exceed2" aria-hidden="true"></i></label></td>
         <td  class="text-center"><label><input class="" name="txtCost[]" id="txtCost2" autocomplete="off" onkeyup="valCostPre(this.value,2,5);" onchange="valCostPre(this.value,2,5);" type="text" placeholder="0"></label><span class="red" id="show-exceed2"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-car eicon exceed4" aria-hidden="true"></i></label></td>
         <td  class="text-center"><label><input type="textbox" placeholder="0"></label></td></tr>
         <tr><td class="text-center"><label ><i class="eicon" >=</i></label></td>
         <td  class="text-center"><label><input type="textbox" placeholder="0" id="totaltable"></label></td></tr>
         </table>
         ...
         <input type="hidden" name="action" id="booking_request_create" value="booking_request_create">
         ...
         <input type="hidden" name="addnewRequesttype" id="addnewRequesttype" value="2">
         </div>
         </span>
         ...
         <div class="container">
            ...
            <div class="col-sm-6">
               <button class="btn btn-primary btn-lg" type="submit" name="addnewRequest" id="addnewRequest" value="2">Submit</button>
