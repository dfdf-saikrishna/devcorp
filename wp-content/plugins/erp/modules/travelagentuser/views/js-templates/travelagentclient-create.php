                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td>Flight</td>
                                                        <td><li class="erp-hr-js-department" data-selected="{{ data.MC_Id}}"><select name="selFlightTerms" id="selFlightTerms" class="form-control input-sm">
                            ...
                            <td><input type="radio" name="company_markups_markdowns[radioFlightMarkStatus]" class="radioFlightMarkStatus" value="1" checked="checked">
                              ...
                              Mark Down </td>
                            <td><input type="text" name="company_markups_markdowns[txtFlightMarkFare]" id="txtFlightMarkFare" class="form-control" maxlength="4"></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><input type="radio" name="company_markups_markdowns[radioBusMarkStatus]" class="radioBusMarkStatus" value="1" checked="checked">
                              ...
                              Mark Down </td>
                            <td><input type="text" name="company_markups_markdowns[txtBusMarkFare]" id="txtBusMarkFare" class="form-control" maxlength="4"></td>
                          </tr>
                          <tr>
                            <td>Hotel</td>
                            <td><li class="erp-hr-js-department" data-selected="{{ data.MC_Id}}"><select name="selFlightTerms" id="selFlightTerms" class="form-control input-sm">
                            ...
                            <td><input type="radio" name="company_markups_markdowns[radioHotelMarkStatus]" class="radioHotelMarkStatus" value="1" checked="checked">
                              ...
                              Mark Down </td>
                            <td><input type="text" name="company_markups_markdowns[txtHotelMarkFare]" id="txtHotelMarkFare" class="form-control" maxlength="4"></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
