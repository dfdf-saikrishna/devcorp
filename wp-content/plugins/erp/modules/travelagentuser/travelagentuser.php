...
class Travelagentuser {
    ...
    private function define_constants() {
        define( 'WPERP_TRAVELAGENT_USER_FILE', __FILE__ );
        define( 'WPERP_TRAVELAGENT_USER_PATH', dirname( __FILE__ ) );
        define( 'WPERP_TRAVELAGENT_USER_VIEWS', dirname( __FILE__ ) . '/views' );
        define( 'WPERP_TRAVELAGENT_USER_JS_TMPL', WPERP_TRAVELAGENT_USER_VIEWS . '/js-templates' );
        define( 'WPERP_TRAVELAGENT_USER_ASSETS', plugins_url( '/assets', __FILE__ ) );
    }
    ...
    private function includes() {
        ...
        require_once WPERP_TRAVELAGENT_USER_PATH . '/includes/actions-filters.php';
		require_once WPERP_TRAVELAGENT_USER_PATH . '/includes/functions-travelagentuser-common.php';
    ...
    public function admin_scripts( $hook ) {
        ...
        wp_enqueue_script( 'wp-erp-tau', WPERP_TRAVELAGENT_USER_ASSETS . "/js/travelagentuser$suffix.js", array( 'erp-script' ), date( 'Ymd' ), true );
        ...
        wp_localize_script( 'wp-erp-tau', 'wpErpTau', $localize_script );
