...
$email = $data['admin']['comadminemail'];
		$duplicate = count($wpdb->get_results("Select user_email From wp_users where user_email='". $email ."'"));
		//$adminduplicate = count($wpdb->get_results("Select  ADM_Email From admin where ADM_Email ='". $email ."'"));
