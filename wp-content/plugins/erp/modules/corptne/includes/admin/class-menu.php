    ...
    public function admin_menu() {
        ...
        *  **********************************/
        if ( current_user_can( 'superadmin' ) ) {
           add_menu_page(__( 'Dashboard', 'superadmin' ),  __( 'Dashboard', 'superadmin' ), 'superadmin', 'dashboard', array( $this, 'dashboard_page'),'dashicons-welcome-view-site' );
          ...
          add_menu_page( __( 'Master Admin Menu', 'superadmin' ), __( 'Master Admin', 'superadmin' ), 'superadmin', 'masteradminmenu', array( $this, 'masteradmin_list'),'dashicons-building' );
           ...
           $overview = add_submenu_page('companiesmenu', 'Add Companies', 'Add Companies', 'superadmin', 'companiesmenu', array( $this, 'companies_list'));
          ...
          add_menu_page( 'Travelagents', 'Travelagents', 'superadmin', 'travelagentsmenu',array( $this, 'travelagent_create'),'dashicons-building');
           ...
           add_menu_page(__( 'WorkFlow', 'superadmin' ), __( 'WorkFlow', 'superadmin' ),  'superadmin', 'workflowsmenu', array( $this, 'workflow'),'dashicons-networking' );
           $overview = add_submenu_page( 'workflowsmenu', 'Overview', 'Overview', 'superadmin', 'workflowsmenu', array( $this, 'workflow'));
           
           add_menu_page(__( 'API', 'superadmin' ), __( 'API', 'superadmin' ),  'superadmin', 'api-selection', array( $this, 'api_selection'),'dashicons-editor-code' );
           $overview = add_submenu_page( 'api-selection', 'Overview', 'Overview', 'superadmin', 'api-selection', array( $this, 'api_selection'));
...
//           add_submenu_page( 'settingsmenu', 'Footer with menu', 'Footer with menu', 'superadmin', '', ''); 
    ...
    public function api_selection() {
        include WPERP_CORPTNE_VIEWS . '/api.php';
    }
