...
class Ajax_Handler {
	...
	//API
	$this->action('wp_ajax_save-Bus', 'save_Bus');
        $this->action('wp_ajax_save-Flight', 'save_Flight');
        $this->action('wp_ajax_save-Hotel', 'save_Hotel');
    }
    ...
    public function save_Bus() {
		...
		$selected = $wpdb->get_row("SELECT Id FROM bus_API WHERE Status='1'");
            	if($selected){
            	$wpdb->update('bus_API', array('Status' => '0'), array('Id' => $selected->Id));	
                $wpdb->update('bus_API', array('Status' => '1'), array('Id' => $selPreTrvPol));
                $response = array('status' => 'success', 'message' => "Bus API updated Successfully");
            ...
            $response = array('status' => 'failure', 'message' => 'Please select an API to update');
            $this->send_success($response);
            exit;
        }
    }
		...
		$selected = $wpdb->get_row("SELECT Id FROM hotel_API WHERE Status='1'");
            	if($selected){
            	$wpdb->update('hotel_API', array('Status' => '0'), array('Id' => $selected->Id));	
                $wpdb->update('hotel_API', array('Status' => '1'), array('Id' => $selPreTrvPol));
                $response = array('status' => 'success', 'message' => "Hotel API updated Successfully");
                $this->send_success($response);
            	exit;
		}
		else{
		...
		$selected = $wpdb->get_row("SELECT Id FROM flight_API WHERE Status='1'");
            	if($selected){
            	$wpdb->update('flight_API', array('Status' => '0'), array('Id' => $selected->Id));	
                $wpdb->update('flight_API', array('Status' => '1'), array('Id' => $selPreTrvPol));
                $response = array('status' => 'success', 'message' => "Flight API updated Successfully");
                $this->send_success($response);
            	exit;
		}
		else{
