...
?>
<h2 style="margin-top: 5%;"><?php _e( 'Companies : ', 'superadmin' ); ?><a href="#" id="erp-company-new" class="add-new-h2 button button-primary" style="    border: 1px solid #13eafe;"><?php _e( 'Add New', 'superadmin' ); ?></a></h2>
