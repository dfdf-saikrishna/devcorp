...
<!--                <li class="erp-hr-js-department" data-selected="0">
                ...
                <li class="erp-hr-js-department" data-selected="0">
                    ...
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" name="company[cbFlight]" id="user_notification">Flight</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" name="company[cbBus]" id="user_notification">Bus</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" name="company[cbHotel]" id="user_notification">Hotel</label></span>
                </li>
            </ol>
        </fieldset>
        <fieldset>
