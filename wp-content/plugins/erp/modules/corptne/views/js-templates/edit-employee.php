<div class="erp-employee-form">
    ...
    <fieldset class="no-border">
        <ol class="form-fields">
            <li>
<input type="hidden" name="company[COM_Id]" value="{{data.COM_Id}}">
...
<!--                <li class="erp-hr-js-department" data-selected="0">
                ...
                <li class="erp-hr-js-department" data-selected="0">
                    ...
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" flight="{{data.COM_Flight}}" name="company[cbFlight]" id="flight">Flight</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" bus="{{data.COM_Bus}}" name="company[cbBus]" id="bus">Bus</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" hotel="{{data.COM_Hotel}}" name="company[cbHotel]" id="hotel">Hotel</label></span>
                </li>
            </ol>
        </fieldset>
        <fieldset>
        ...
        <fieldset>
            <legend>Tally Connection</legend>

            <ol class="form-fields two-col">
                <li class="erp-hr-js-department" data-selected="0">
                    <label for="company[department]">Folder Name</label>
                    <input value="{{data.COM_TallyFolder}}" name="company[tallyFolder]" id="personal[employee_id]" type="text" disabled>
                </li>
                <li class="erp-hr-js-department" data-selected="0">
                    <label for="company[host]">FTP Host</label>
                    <span><b>ftp.corptne.com</b></span>
                </li>
                <li class="erp-hr-js-department" data-selected="0">
                    <label for="company[department]">FTP Username</label>
                    <input value="{{data.COM_TallyUsername}}" name="company[txtFtpUsr]" id="personal[employee_id]" type="text">
                </li>
                <li class="erp-hr-js-department" data-selected="0">
                    <label for="company[department]">FTP Password</label>
                    <input value="{{data.COM_TallyPwd}}" name="company[txtFtpPwd]" id="personal[employee_id]" type="password">
                </li>
                <li>
            </ol>
        </fieldset>
