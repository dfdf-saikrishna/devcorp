<div class="erp-employee-form">
    ...
    <fieldset class="no-border">
        ...
        <ol class="form-fields">
            <li>
                <label for="full-name">Upload456 Company Logo</label>
...
<!--                <li class="erp-hr-js-department" data-selected="0">
                ...
                <li class="erp-hr-js-department" data-selected="0">
                    ...
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" <?php if({{data.COM_Flight}} ==1) echo 'checked="checked"'; ?>  name="company[cbFlight]" id="user_notification">Flight</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" <?php if({{data.COM_Bus}} ==1) echo 'checked="checked"'; ?> name="company[cbBus]" id="user_notification">Bus</label></span>
                    <span class="checkbox"><label for="user_notification"><input type="checkbox" value="1" <?php if({{data.COM_Hotel}} ==1) echo 'checked="checked"'; ?> name="company[cbHotel]" id="user_notification">Hotel</label></span>
                </li>
            </ol>
        </fieldset>
        <fieldset>
