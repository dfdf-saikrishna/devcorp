            ...
            foreach ( $left_column as $key => $report ) {
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <p><a class="button button-primary" href="admin.php?page=erp-accounting-reports&type=<?php echo esc_attr( $key ); ?>"><?php _e( 'View Report', 'erp' ); ?></a></p>
                    </div>
                </div><!-- .postbox -->
            <?php
                }
        ...
        <div class="postbox-container">
            ...
            foreach ( $right_column as $key => $report ) {
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><?php echo esc_html( $report['description'] ); ?></p>
                        <p><a class="button button-primary" href="admin.php?page=erp-accounting-reports&type=<?php echo $key; ?>"><?php _e( 'View Report', 'erp' ); ?></a></p>
                    </div>
                </div><!-- .postbox -->
            <?php
                }
