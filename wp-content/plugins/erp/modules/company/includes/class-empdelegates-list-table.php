...
class Empdelegates_List_Table extends \WP_List_Table
{
    ...
    function column_To($item){
        ...
        $toid = $wpdb->get_row("SELECT EMP_Code,EMP_Name FROM employees WHERE EMP_Id=$toempId");
        //print_r($toid);die;		
		return $toid->EMP_Code ."<br> ". $toid->EMP_Name;
    }
	...
	function column_From($item)
    {
		...
		$fromid = $wpdb->get_row("SELECT EMP_Code,EMP_Name FROM employees WHERE EMP_Id=$fromempId");
					  
		return $fromid->EMP_Code."<br> ". $fromid->EMP_Name;
    }
