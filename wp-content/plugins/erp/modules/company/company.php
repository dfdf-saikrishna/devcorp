...
class Company {
    ...
    private function includes() {
        ...
        require_once WPERP_COMPANY_PATH . '/includes/function-categorybudget.php';
...
//        require_once WPERP_COMPANY_PATH . '/includes/actions-filters.php';
    ...
    public function admin_scripts($hook) {
        ...
        $localize_script = apply_filters('erp_hr_localize_script', array(
            ...
            'popup' => array(
  'add' => __('Add Expense Category', 'erp'),
                'edit' => __('Edit Expense Category', 'erp'),
                ...
                'costcenter_title' => __('Add Cost center budget limit', 'erp'),
                ...
                'projectbudget_title' => __('Add Projectbudget Details', 'erp'),
                'projectcode_submit' => __('Submit', 'erp'),
                'projectcode_edit' => __('Edit Projectcode Details', 'erp'),
                'projectbudget_edit' => __('Edit Projectbudget Details', 'erp'),
                'categorybudget_title' => __('Add Category budget limits', 'erp'),
                'categorybudget_submit' => __('Submit', 'erp'),
                'categorybudget_edit' => __('Edit Projectcode Details', 'erp'),
        ...
        if ('budget-control_page_Project' == $hook) {
            wp_enqueue_script('post');
            $projectcode = new Projectcode();
            $localize_script['projectcode_empty'] = $projectcode->projectcode_array();
        }
        if ('budget-control_page_project-budget' == $hook) {
            wp_enqueue_script('post');
            $projectbudget = new Projectcode();
            $localize_script['projectbudget_empty'] = $projectbudget->projectbudget_array();
        }
    ...
    public function admin_js_templates() {
        ...
        switch ($current_screen->base) {
            case 'expense-managment_page_addcat':
            	 erp_get_js_template(WPERP_COMPANY_JS_TMPL . '/subcats-edit.php', 'subcats-edit');
            	 
            case 'budget-control_page_project-budget':
            	 erp_get_js_template(WPERP_COMPANY_JS_TMPL . '/project-budget-create.php', 'add-project-budget');
            ...
            case 'budget-control_page_Project':
            ...
            case 'budget-control_page_Category':
                //var_dump('inside');
                erp_get_js_template(WPERP_COMPANY_JS_TMPL . '/categorybudget-create.php', 'categorybudget-create');
