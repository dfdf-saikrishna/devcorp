...
$testArray = array("Employee Code", "Name", "Email ID", "Department", "Reporting Manager (Emp code)", "Mobile Number", "ProjectCode", "Designation", "Functional Reporting manager (Emp Code)", "Grade","Costcenter", "Error Message");
                ...
                <?php foreach ($objPHPExcelRead->getWorksheetIterator() as $worksheet)
                    {
                        ...
                        $highestRow = $sheet->getHighestDataRow();     //Getting number of rows
                ...
                <table cellpadding="2" cellspacing="2" border="1" class="wp-list-table widefat">
                   ...
                   <?php
                            ...
                            if (preg_match('/\b' . $rowData[0][0] . '\b/',$empnotadded)){
                                ...
                                $email = $rowData[0][2];
                                if($rowData[0][0] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Empid Missing');
                                    $empID = true;
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Empid Missing'>";
                                }
                                else if($rowData[0][2] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Email Id Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Email Id Missing'>";
                                }
                                else if($rowData[0][4] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Reporting Manager Code Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Reporting Manager Code Missing'>";
                                }
                                else if($rowData[0][8] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Functional Reporting Manager Code Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Functional Reporting Manager Code Missing'>";
                                }
                                else if($rowData[0][9] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Employee Grade Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Employee Grade Missing'>";
                                }
                                else if($rowData[0][10] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Employee Costcenter Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Employee Costcenter Missing'>";
                                }
                                else if($rowData[0][1] == "" || $rowData[0][3] == "" || $rowData[0][7] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Missing Required Data');
                                    ...
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("11", $row, 'Employee Email already Exists');
