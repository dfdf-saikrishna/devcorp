...
<!--    <input type="hidden" value="{{data.ADM_Id}}" name="company[adminid]" id="adminid">-->
    ...
    <div class="row">
        <?php erp_html_form_label(__('CostCenter Budget', 'erp'), 'costcenter-title', true); ?>
        <span class="field">
            <input value="{{data.cc_Budget}}"  required name="company[txtCostCenterBudget]" id="txtCostCenterCode" >
        </span>
    </div>
    <!--div class="row">
