                    ...
                    foreach ($selsql as $rowsql) {
                      ...
                      <div class="table-responsive">
                        <table class="wp-list-table widefat striped admins" onmouseover="this.style.fontWeight='bold'" onmouseout="this.style.fontWeight='normal'">
                          ...
                          <table class="hide-table<?php echo $rowsql->REQ_Id;?> wp-list-table invoice-details widefat striped admins collapse" style="font-size:11px;">
                            <thead>
                              <tr>
                                <th width="10%">Date</th>
...
$imdir = WPERP_COMPANY_DOWNLOADS .'/company/upload/'. $cmpid .'/bills_tickets/';	
	...
	<tr><td><p><button name="accTdClaimed" id="accTdClaimed" class="button button-primary"  type="submit">Submit</button></p></td> <td><p>&nbsp;&nbsp;</p></td> <td><p><button type="reset" class="button erp-button-danger" >Cancel</button></p></td></tr>
			...
			<tr><td><p> Total Amount</p></td> <td><p>&nbsp;:&nbsp;</p></td> <td><p><?php echo IND_money_format($totalamnt + $servTax + $rows->TDC_ServiceCharges) . '.00'; ?></p></td></tr>
			</tbody></table>
	                </div>
