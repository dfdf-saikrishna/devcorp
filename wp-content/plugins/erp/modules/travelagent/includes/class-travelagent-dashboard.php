...
class Travelagentdashboard_List_Table extends \WP_List_Table
{
	...
	function column_cancelreq($item){
        ...
        return sprintf('%s %s %s',
            '',
            '<a href="'.erp_travelagent_requestview( $item['COM_Id'],2).'"><span class="oval-4"><strong>' . getCountRequests(2, $item['COM_Id']) . '</span></strong></a>',''
        );
    }
	...
	function column_totbookingreq($item){
        ...
        return sprintf('%s %s %s',
            '',
            '<a href="'.erp_travelagent_requestview( $item['COM_Id'],3).'"><span class="oval-2"><strong><strong>' . getCountRequests(3, $item['COM_Id']) . '</span></strong></a>',''
        );
    }
	...
	function column_totcancelreq($item){
        ...
        return sprintf('%s %s %s',
            '',
            '<a href="'.erp_travelagent_requestview( $item['COM_Id'],4).'"><span class="oval-4"><strong>' . getCountRequests(4, $item['COM_Id']) . '</span></strong></a>',''
        );
    }
    /**
