...
function erp_company_url_invoice_view($cmpid){
    $url = admin_url( 'admin.php?page=createinvoice&action=view&id='.$cmpid);

    return apply_filters( 'erp_invoicedetails_url_single_view', $url, $cmpid);
}
