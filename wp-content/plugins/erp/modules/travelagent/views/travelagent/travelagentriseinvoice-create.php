    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          ...
          <form class="form-horizontal" method="post" id="invoiceForm" name="invoiceForm" enctype="multipart/form-data">
            ...
            <div class="panel-body">
			  ...
			  $supid = $_SESSION['supid'];
				...
				$selba = $wpdb->get_results("SELECT TDBA_Id, TDBA_AccountNumber FROM travel_desk_bank_account WHERE SUP_Id = '$supid' AND  TDBA_Status=1 AND TDBA_Type = 2"); 
			  ...
			  ?>
			  <input type="hidden" value="<?php echo $supid; ?>" name="supid" />
              <div class="invoice">
                <!--<div class="row">
                <div class="col-sm-6">
                  <?php 
				...
				if($comrow->COM_LOGO)
				echo '<img alt="" src="../admin/'.$comrow->COM_LOGO .'> ';
                ...
                <div class="row">
                  ...
                  <div class="erp-area-right erp-hide-print" style="margin:0px 0px 0px 600px" >
                    <div class="col-sm-12">
                      <h4>Payment Details :</h4>
                    </div>
                    <div class="col-sm-4"> <strong>Service Tax:</strong> </div>
                    <div class="col-sm-4">
                    ...
                    <div class="clearfix"></div>
                    <br />
                    <div class="col-sm-4"> <strong>Service Charges:</strong> </div>
                    <div class="col-sm-4">
                      <div class="input-group">
                ...
                <?PHP
				global $wpdb;
				$selsql = $wpdb->get_results("SELECT DISTINCT(req.REQ_Id), req.* FROM requests req, request_details rd, booking_status bs WHERE req.COM_Id='$cmpid' AND req.REQ_Id IN ($reqids) AND req.REQ_Id=rd.REQ_Id  AND rd.RD_Id=bs.RD_Id AND BS_Active=1 ORDER BY bs.BS_Id DESC LIMIT 0, 10");
    ...
    ?>
		...
		if(!empty($selrdcs->BA_Id))	{
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="align-lg-right" style="margin:0px 0px 0px 300px">
                      <ul>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                   ...
                   <button type="submit" name="claimsSubmit" id="claimsSubmit" class="button button-primary">Send for Claims</button>
					 <input type="hidden" name="action" id="travelagentclaims_create" value="travelagentclaims_create">
                    </div>
                  </div>
                </div>
                <?php } ?>
