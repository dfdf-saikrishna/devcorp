...
$selsql = $wpdb->get_results("SELECT DISTINCT(req.REQ_Id), req.* from requests req, request_details rd, booking_status bs WHERE req.COM_Id='$cmpid' $q AND "
    ...
    ?>
            ...
            <a href="#" id="travelagentrise_invoice" class="button button-primary">Raise Invoice</a>
            ...
            <div class="panel-group">
              ...
              <?php
                                ...
                                foreach ($selsql as $rowsql) {
									...
									$selsql = "
										...
										SELECT 
										  ...
										  GROUP_CONCAT(DISTINCT CONVERT(rd.RD_Id, CHAR(8))) AS rdids,
										  ...
										  GROUP_CONCAT(DISTINCT CONVERT(bs.BA_Id, CHAR(8))) AS baids,
										...
										req.REQ_Id = '$rowsql->REQ_Id' AND bs.BS_Status IN (1,3) AND rd.RD_Status = 1
										AND BS_Active = 1
										GROUP BY
										  req.REQ_Id
									...
									switch ($rowsql->REQ_Type){
										...
										case 2:
											...
											$href='travel-agent-user-request-details.php';
										...
										case 4:
											...
											$href='travel-agent-user-group-request-details.php';
						...
						$baidsarry = explode(",", $getvals->baids);
						
						//echo $getvals['baids'].'<br>'; 
						
						//echo 'baid='.$getvals['baid'].'<br>'; 
						...
						if( in_array(1, $baidsarry) ) {
							...
							$selclmreqid = $wpdb->get_row("SELECT REQ_Id, TDC_Status FROM travel_desk_claims tdc, travel_desk_claim_requests tdcr WHERE tdc.COM_Id='$cmpid' and tdc.TDC_Id=tdcr.TDC_Id AND tdcr.REQ_Id='$rowsql->REQ_Id'");
							
														
							 
							
							switch($selclmreqid->TDC_Status){
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                      <tr>
                        ...
                        <td width="5%"><input type="checkbox" name="reqid[]" value="<?php echo $rowsql->REQ_Id?>"   <?php echo $disabled ? 'disabled="disabled"': null;  echo $void .' '.$onclick; ?> /></td>
