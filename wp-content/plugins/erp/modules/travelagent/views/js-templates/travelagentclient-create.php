    ...
    <fieldset>
                  ...
                  <div class="col-md-8">
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                            <th style="text-align:left;" width="20%">Modes</th>
                            <th style="text-align:left;">Tariff/fare Type</th>
                            <th width="25%">Mark Up/Down</th>
                            <th width="25%">Mark Tariff/fare</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td>Flight</td>
                                <td><li class="erp-hr-js-department" data-selected="{{data.flight.MC_Id}}"><select name="company_markups_markdowns[selFlightTerms]" id="selFlightTerms" class="form-control input-sm">
            					<option value="">Select</option>
            					<?php for($i=0; $i<$count; $i++){ ?>
            					<option value="<?php echo $markupdown[$i]->MC_Id; ?>"><?php echo $markupdown[$i]->MC_Name; ?></option>
            					<?php } ?>
            					</select></li></td>
            					<li data-flight="{{data.flight.CMM_MarkStatus}}">
                            <td><input type="radio" name="company_markups_markdowns[radioFlightMarkStatus]" class="radioFlightMarkStatus" value="1" checked="checked">
                              Mark Up </br>
                              <input type="radio" name="company_markups_markdowns[radioFlightMarkStatus]" class="radioFlightMarkStatus" value="2">
                              Mark Down </td>
                              </li>
                            <td><input type="text" name="company_markups_markdowns[txtFlightMarkFare]" id="txtFlightMarkFare" class="form-control" maxlength="4" value="{{data.flight.CMM_MarkFare}}"></td>
                          </tr>
                          ...
                          <tr>
                            <td>Bus</td>
                            <td><li class="erp-hr-js-department" data-selected="{{ data.bus.MC_Id}}"><select name="company_markups_markdowns[selBusTerms]" id="selFlightTerms" class="form-control input-sm">
                                    					<option value="">Select</option>
                                    					<?php for($i=0; $i<$count; $i++){ ?>
                                    					<option value="<?php echo $markupdown[$i]->MC_Id; ?>"><?php echo $markupdown[$i]->MC_Name; ?></option>
                                    					<?php } ?>
                                    					</select></li></td>
                                    					<li data-bus="{{data.bus.CMM_MarkStatus}}">
                            <td><input type="radio" name="company_markups_markdowns[radioBusMarkStatus]" class="radioBusMarkStatus" value="1" checked="checked">
                              Mark Up </br>
                              <input type="radio" name="company_markups_markdowns[radioBusMarkStatus]" class="radioBusMarkStatus" value="2">
                              Mark Down </td>
                              </li>
                            <td><input type="text" name="company_markups_markdowns[txtBusMarkFare]" id="txtBusMarkFare" class="form-control" maxlength="4" value="{{data.bus.CMM_MarkFare}}"></td>
                          </tr>
                          <tr>
                            <td>Hotel</td>
                            <td><li class="erp-hr-js-department" data-selected="{{ data.hotel.MC_Id}}"><select name="company_markups_markdowns[selHotelTerms]" id="selFlightTerms" class="form-control input-sm">
                                    					<option value="">Select</option>
                                    					<?php for($i=0; $i<$count; $i++){ ?>
                                    					<option value="<?php echo $markupdown[$i]->MC_Id; ?>"><?php echo $markupdown[$i]->MC_Name; ?></option>
                                    					<?php } ?>
                                    					</select></li></td>
                                    					<li data-hotel="{{data.hotel.CMM_MarkStatus}}">
                            <td><input type="radio" name="company_markups_markdowns[radioHotelMarkStatus]" class="radioHotelMarkStatus" value="1" checked="checked">
                              Mark Up </br>
                              <input type="radio" name="company_markups_markdowns[radioHotelMarkStatus]" class="radioHotelMarkStatus" value="2">
                              Mark Down </td>
                              </li>
                            <td><input type="text" name="company_markups_markdowns[txtHotelMarkFare]" id="txtHotelMarkFare" class="form-control" maxlength="4" value="{{data.hotel.CMM_MarkFare}}"></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
		...
		<ol class="form-fields ">
                ...
                <li class="erp-hr-js-department" data-selected={{data.SUP_Id}}>
					<label>Employees (Multi Selectable)</label>
					<select required name="selTrvAgntUser[]" style="width:50%;" multiple="multiple" id="selTrvAgntUser" class="form-control erp-select2">
					<option value="">Select</option>
					<?php for($i=0; $i<$count; $i++){ ?>
