...
?>
<div id="new_note">
    <trix-editor v-if="!feed" id="note-text-editor" input="note_activity_message" placeholder="<?php _e( 'Type your note .....', 'erp' ); ?>"></trix-editor>
    <input v-if="!feed" id="note_activity_message" v-model="feedData.message" type="hidden" name="note_activity_message" value="">

    <trix-editor v-if="feed" id="note-text-editor" input="note_activity_message_{{ feed.id }}" placeholder="<?php _e( 'Type your note .....', 'erp' ); ?>"></trix-editor>
    ...
    <div class="submit-action">
        ...
        <input type="submit" v-if="!feed" :disabled = "!isValid" class="button button-primary" name="save_notes" value="<?php _e( 'Save Note', 'erp' ); ?>">
        <input type="submit" v-if="feed" :disabled = "!isValid" class="button button-primary" name="edit_notes" value="<?php _e( 'Update Note', 'erp' ); ?>">
