...
<div class="terminate-form-wrap">
    ...
    <div class="row" data-selected="{{ data.termination_type }}">
        <?php erp_html_form_input( array(
            ...
            'required' => true,
            'id'      => 'termination_type',
            'options' => array( '' => __( '- Select -', 'erp' ) ) + erp_hr_get_terminate_type()
        ) ); ?>
    </div>
    ...
    <div class="row" data-selected="{{ data.termination_reason }}">
        <?php erp_html_form_input( array(
            ...
            'options' => array( '' => __( '- Select -', 'erp' ) ) + erp_hr_get_terminate_reason()
        ) ); ?>
    </div>
    ...
    <div class="row" data-selected="{{ data.eligible_for_rehire }}">
        <?php erp_html_form_input( array(
            ...
            'options' => array( '' => __( '- Select -', 'erp' ) ) + erp_hr_get_terminate_rehire_options()
        ) ); ?>
    </div>
