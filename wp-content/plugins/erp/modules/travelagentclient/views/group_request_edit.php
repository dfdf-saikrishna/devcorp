...
<div class="postbox">
   <div class="inside">
      <div class="wrap pre-travel-request erp request" id="wp-erp">
         <h2><?php _e( 'Group Booking Request Edit', 'employee' ); ?></h2>
         <!--<code class="description">ADD Request</code>-->
         <form id="group_request_edit_form" name="request_edit_form" action="#" method="post">
            <!-- Messages -->
            ...
            <?php
               ...
               $selsql	=	 "
				...
				SELECT
				  re.EMP_Id, re.VD_Id, EMP_Name, PI_Gender, EMP_Code, PI_DateofBirth, EMP_Email, EMP_Phonenumber, PI_MealPreference
				FROM
				  request_employee re,
				  employees emp,
				  personal_information pnf
				WHERE
				  re.REQ_Id = '$reqid' AND re.EMP_Id = emp.EMP_Id AND re.EMP_Id = pnf.EMP_Id AND re.RE_Status = 1 AND pnf.PI_Status = 1
				  
				  ";
				 
				 
				$empdetails = $wpdb->get_results($selsql);
				
				
				 $cntEmp = count($empdetails);
				
				$fieldArr = array();
				$dis = 0;
				
				if(count($empdetails) <= 2) {
			  ...
			  $grpreq = 1; 
			  $i = 1; ?>
              <input type="hidden" value="<?php echo count($empdetails) ?>" name="empcount" id="empcount"  />
              <input type="hidden" <?php /*?>value="<?php echo join(",", $fieldArr); ?>"<?php */?> name="fields" id="fields" />
              <?php
			  foreach($empdetails as $val){	
               ?>
               <!-- Employee Details -->
               
               <div class="col-lg-12" id="employeeDiv<?php echo $i; ?>">
                <input type="hidden" class="form-control grpempcode"  name="txtGrpEmpCode<?php echo $i; ?>" id="txtGrpEmpCode<?php echo $i; ?>" maxlength="30" value="<?php echo $val->EMP_Code; ?>">
                <div id="employeedetails<?php echo $i; ?>" >
                  <div class="col-lg-8">
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
                          <tr>
                            <th colspan="3" style="text-align:left">Employee Details #<?php echo $i; ?></th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td width="5%">:</td>
                            <td id="employeeName<?php echo $i; ?>" width="25%"><?php echo $val->EMP_Name; ?></td>
                          </tr>
                          <tr>
                            <td>Gender</td>
                            <td >:</td>
                            <td id="employeeGender<?php echo $i; ?>"><?php echo $val->PI_Gender; ?></td>
                          </tr>
                          <tr>
                            <td width="20%">Employee Code</td>
                            <td >:</td>
                            <td id="employeeName<?php echo $i; ?>" width=""><?php echo $val->EMP_Code; ?></td>
                          </tr>
                          <tr>
                            <td>Date Of Birth</td>
                            <td >:</td>
                            <td id="employeeDob<?php echo $i; ?>"><?php echo date('d-m-Y', strtotime($val->PI_DateofBirth)); ?></td>
                          </tr>
                          <tr>
                            <td>Email</td>
                            <td >:</td>
                            <td id="employeeEmail<?php echo $i; ?>"><?php echo $val->EMP_Email; ?></td>
                          </tr>
                          <tr>
                            <td>Mobile</td>
                            <td >:</td>
                            <td id="employeeMobile<?php echo $i; ?>"><?php echo $val->EMP_Phonenumber; ?></td>
                          </tr>
                          <tr>
                            <td>Meal Preference</td>
                            <td >:</td>
                            <td id="employeeMealPrf<?php echo $i; ?>"><?php echo $val->PI_MealPreference; ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
				...
				if($row->REQ_Method == 'international'){
					...
					$selsql = "
						...
						SELECT PAS_ImageFrontView as psprtfrontview, PAS_ImageBackView as psprtbackview, PAS_Passportno as passno, PAS_IssuedCountry as issudcntry, PAS_IssuedPlace as issudplc, PAS_IssuedDate as issuddate, PAS_ExpiryDate as expirydate FROM passport_detials WHERE EMP_Id = '$val->EMP_Id'
					...
					$psprtrow = $wpdb-get_row($selsql);
				
				 
				  
				  ?>
                <div id="employeepassportdetails<?php echo $i; ?>" >
                  <div class="col-lg-8">
                    <div class="table-responsive">
                      <table class="table" >
                        <thead>
                ...
                <?php 
				  ...
				  $visarow=select_query("visa_details", "*", "VD_Id = $val->VD_Id", $filename, 0);
				  
				  
				  
				  
				  ?>
                <div id="employeevisadetails<?php echo $i; ?>" >
                  <div class="col-lg-8">
                    <div class="table-responsive">
                      <table class="table" >
                        <thead>
				...
				?>
                <?php if($cntEmp > 2){ ?>
                <button class="btn btn-danger" onclick="removeGrpEmp(<?php echo $reqid; ?>, <?php echo $val->EMP_Id?>, <?php echo $i; ?>)" type="button" name="removeGrpEmp<?php echo $i; ?>" id="removeGrpEmp<?php echo $i; ?>" <?php echo $dis ? 'disabled="disabled"' : ''; ?> >- Remove </button>
                <?php } ?>
              ...
              <div class="col-lg-6 text-right" id="addmore<?php echo $i-1; ?>">
                <button class="btn btn-palevioletred" type="button" name="addmorebutton<?php echo $i-1; ?>" id="addmorebutton<?php echo $i-1; ?>" value="<?php echo $i-1; ?>" onclick="addmore(<?php echo $i-1; ?>)">+ Add More</button>
              </div>
              <div class="clearfix"></div>
              <p>&nbsp;</p>
		 ...
		 {
		 $totalcost+=$rowrequest->RD_TotalCost;
		 $classes=null;
         ...
         <i class="fa fa-map-marker input-icon"></i>
         <div class="st-select-wrapper">
         <input data-children="location_id_drop_off" data-clear="clear" type="text" name="from[]" value="<?php echo $corigin; ?>" class="car form-control required" id="carcity4" placeholder="City or Destination ">
         <div class="option-wrapper"></div>
         </div>
         </div>
         ...
         <i class="fa fa-calendar input-icon input-icon-highlight"></i>
         <input placeholder="dd/mm/yyyy" value="<?php echo $cdatefrom;?>" class="form-control pretraveldate off" id="txtcarDate4" name="txtDate[]" type="text">
         </div>
         </div>
         <div class="col-md-6">
         <div class="form-group form-group- form-group-icon-left">
         ...
         <input id="field-car-pickup-time" name="pickup" class="time-pick form-control off" value="<?php echo $cpickup;?>" type="text">
         </div>
         </div>
         </div>
         </div>
         ...
         <i class="fa fa-calendar input-icon input-icon-highlight"></i>
         <input placeholder="dd/mm/yyyy" value="<?php echo $cdateto;?>" class="form-control pretraveldate off" id="txtcarDateto4" name="dateTohotel[]" type="text">
         </div>
         </div>
         <div class="col-md-6">
         <div class="form-group form-group- form-group-icon-left">
         ...
         <i class="fa fa-clock-o input-icon input-icon-highlight"></i>
         <input id="field-st-dropoff-time" name="dropoff" class="time-pick form-control off" value="<?php echo $cdropoff;?>" type="text">
         </div>
         </div>
         </div>                    </div>
         <div class=" col-md-2 col-lg-2 col-sm-12 col-xs-12 form-group form-group- form-group-select-plus">
         <label for="field-hotel-room-num">Description</label>
         <textarea name="txtaExpdesc[]" id="txtaExpdesc4" class="" autocomplete="off"><?php echo $cdescription; ?></textarea>
         </div>
         </div>
         </div>
         ...
         <td  class=""><label><input class="" style="width: 80%;margin-right: 8%;" value="<?php echo $fcost; ?>" <?php echo $fstatus; ?> name="txtCost[]" id="txtCost1" autocomplete="off" onkeyup="calcTotalCost()" onchange="calcTotalCost()" type="text" placeholder="0"><?php echo $fdelete; ?></label><span class="red" id="show-exceed1"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-bus eicon exceed3" aria-hidden="true"></i></label></td>
         <td  class=""><label><input class="" style="width: 80%;margin-right: 8%;" name="txtCost[]" value="<?php echo $bcost; ?>" <?php echo $bstatus; ?> id="txtCost3" autocomplete="off" onkeyup="calcTotalCost()" onchange="calcTotalCost()" type="text" placeholder="0"><?php echo $bdelete; ?></label><span class="red" id="show-exceed3"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-hospital-o eicon exceed2" aria-hidden="true"></i></label></td>
         <td  class=""><label><input class="" style="width: 80%;margin-right: 8%;" name="txtCost[]" value="<?php echo $hcost; ?>" id="txtCost2" autocomplete="off" onkeyup="calcTotalCost()" onchange="calcTotalCost()" type="text" placeholder="0"><?php echo $hdelete; ?></label><span class="red" id="show-exceed2"></span></td></tr>
         <tr><td  class="text-center"><label ><i class="fa fa-car eicon exceed4" aria-hidden="true"></i></label></td>
         <td  class=""><label><input class="" style="width: 80%;margin-right: 8%;" name="txtCost[]" value="<?php echo $ccost; ?>" id="txtCost4" autocomplete="off" onkeyup="valCostPre(this.value,4,3);" onchange="valCostPre(this.value,4,3);" type="text" placeholder="0"><?php echo $cdelete; ?></label><span class="red" id="show-exceed4"></span></td></tr>
         <tr><td class="text-center"><label ><i class="eicon" >=</i></label></td>
         <td  class=""><label><input type="textbox" placeholder="0" style="width: 80%;margin-right: 8%;" name="txtTotalCost[]" id="txtTotalCost" readonly="true" value="<?php echo $totalcost; ?>" id="totaltable"></label></td></tr>
         </table>
         ...
         <input type="hidden" value="5" name="updateRequest" id="updateRequest" />
		...
		$a++;
         ...
         <div class="container">
            ...
            <div class="col-sm-6">
               <button class="btn btn-primary btn-lg" value="Update" name="update" id="updateGroupRequest" type="submit">Update</button>
