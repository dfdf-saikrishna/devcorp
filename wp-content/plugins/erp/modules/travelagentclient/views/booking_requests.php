...
<div class="filter-top">
    ...
    <div class="col-md-2">
        <input type="submit" class="btn btn-primary" value="Filter Requests">
    </div>
    <div class="col-md-2">
        <a href="admin.php?page=Add" class="btn btn-primary btn-block">Add Request</a>
    </div>
</div>
	...
	<?php
        ...
        $message = '';
            if ('delete' === $employee_table->current_action()) {
                ...
                ?>
     <div class="list-table-wrap erp-hr-employees-wrap box panel-widget-style" style="margin-bottom:20px;">
