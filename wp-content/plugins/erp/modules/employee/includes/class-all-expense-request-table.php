...
class All_Expense_Requests_List extends \WP_List_Table {
    ...
    function extra_tablenav($which) {
        ...
        function column_request_code($item) {
            ...
            switch ($item['RT_Id']) {
                case 1:
                    $href = "admin.php?page=Pretravel+view&&reqid=" . $item['REQ_Id'];
                    break;
        ...
        function column_action($item) {
            ...
            $post_view_clm = '<span class="tooltip-area"> <a href="admin.php?page=View-Post-Accounts-Request&reqid=' . $item['REQ_Id'] . '" class="btn btn-default btn-sm" title="View Details"><i class="fa fa-file-text-o"></i></a></span>';

            $oth_view_clm = '<span class="tooltip-area"> <a href="admin.php?page=View-Others-Accounts-Request&reqid=' . $item['REQ_Id'] . '" class="btn btn-default btn-sm" title="View Details"><i class="fa fa-file-text-o"></i></a></span>';

            $utl_view_clm = '<span class="tooltip-area"> <a href="admin.php?page=View-Mileage-Accounts-Request&reqid=' . $item['REQ_Id'] . '" class="btn btn-default btn-sm" title="View Details"><i class="fa fa-file-text-o"></i></a></span>';
