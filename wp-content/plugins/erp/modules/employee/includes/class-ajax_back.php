            ...
            case 3:
                if ($polId == 5) {
                    ...
                    $wpdb->insert('request_status', array('REQ_Id' => $reqid, 'EMP_Id' => $empuserid, 'REQ_Status' => 2, 'RS_EmpType' => 5));
						...
						$wpdb->update('request_status', array('REQ_Status' => 2, 'EMP_Id' => $empuserid, 'RS_EmpType' => 5), array('REQ_Id' => $reqid));
						$wpdb->update('requests', array('REQ_Status' => 2), array('REQ_Id' => $reqid));
						break;
					}
                    //$wpdb->update('requests', array('REQ_Status' => 2), array('REQ_Id' => $reqid));
...
//        }
        ...
        switch ($exptype) {
            ...
            case 'Flight':
                ...
                $quoteResult = getFlight($posted, $exptype, $selection);
            ...
            case 'Bus':
                ...
                $quoteResult = getBus($posted, $exptype, $selection);
