               ...
               <div class="">
                ...
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#others" data-toggle="tab"><i class="fa fa-money"></i> <span class="hidden-sm hidden-xs"> &nbsp; Others</span></a></li>
                        </ul>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="flight">
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="fileclearf">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="fileclearf">
