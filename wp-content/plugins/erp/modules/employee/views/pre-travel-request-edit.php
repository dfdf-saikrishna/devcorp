      ...
      <div class="wrap pre-travel-request erp request" id="wp-erp">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="flight">
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off pretraveldate flightDatefrom" name="txtDate[]" value="<?php echo date('d-m-Y',strtotime($rowrequest->RD_Dateoftravel)); ?>" id="flightDatefrom<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="dd/mm/yyyy">
                                ...
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="dateTohotelflight">
                        ...
                        <div class="tab-pane fade" id="bus">
                            ...
                            ?>
                                ...
                                <input type="hidden" id="children<?php echo $row; ?>" name="children" value="0">
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="dateTohotelbus">
                        ...
                        <div class="tab-pane fade" id="hotel">
                            ...
                            <div class="row" style="margin:10px 0;">
								...
								<?php
								$rdid = $rowrequest->RD_Id;
                                $hiddenPrefrdSelectedhotel = 0; 
                                $sessionidhotel = time();
                                $hiddenAllPreferedhotel = 0;
                                $selrgquote=$wpdb->get_results("SELECT * FROM request_getquote rg, get_quote_flight gqf WHERE RD_Id='$rdid' AND rg.GQF_Id=gqf.GQF_Id AND RG_Active=1");
								if(count($selrgquote)){
                        	 	$gqfidhotel=array();
								$roundtrip=array();
                                foreach($selrgquote as $values){
        						    array_push($gqfidhotel, $values->GQF_Id);
									if($values->RG_Pref==2)
									array_push($roundtrip, $values->GQF_Id);
        						    $hiddenPrefrdSelectedhotel=join(",", $roundtrip);
        						    $sessionidhotel=$values->RG_SessionId;
        						    $hiddenAllPreferedhotel=join(",", $gqfidhotel);
        					
        					    } } ?>
                                <input type="hidden" name="sessionid[]" id="sessionidhotel<?php echo $row; ?>" value="<?php echo $sessionidhotel; ?>"/>
                                <input type="hidden"  name="hiddenPrefrdSelected[]" id="hiddenPrefrdSelectedhotel<?php echo $row; ?>" value="<?php echo $hiddenPrefrdSelectedhotel; ?>"/>
                                <input type="hidden" name="hiddenAllPrefered[]" id="hiddenAllPreferedhotel<?php echo $row; ?>" value="<?php echo $hiddenAllPreferedhotel; ?>"/>
                            ...
                            <div class="row" style="margin:10px 0;">
								...
								<div id="quotefieldsid1">
                                     ...
                                     <input type="hidden"  name="hiddenPrefrdSelected[]" id="hiddenPrefrdSelectedhotel1"/>
                                     <input type="hidden" name="hiddenAllPrefered[]" id="hiddenAllPreferedhotel1"/>
                                </div>
                                <input type="hidden" id="children1" name="children" value="0">
                                <input type="hidden" id="infants1" name="infants" value="0">
                                <input type="hidden" name="flightReturn[]" value="">
                        ...
                        <div class="tab-pane fade" id="car">
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" id="children<?php echo $row; ?>" name="children" value="0">
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="dateTohotelcar">
         ...
         <div class="container-fluid create-btn-tab">
            <div class="col-md-12" style="text-align:center;">
               ...
               <button class="btn btn-warning btn-md" type="submit" value="Save" name="save" id="save-pre-travel-request">Save&nbsp;</button>
