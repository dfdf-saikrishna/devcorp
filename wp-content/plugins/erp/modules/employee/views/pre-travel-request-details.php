...
<style type="text/css">
   ...
   /* Quote */	
		...
		if($category_budgets){
	    	...
	    	{
	    	?>
	    	<div style="display:block" id="failure" class="alert alert-danger fade in alert-dismissable notice notice-error is-dismissible">
                <p style="text-align:center" id="p-failure">Budget Limit Reached 100% this Request cannot be Approved</p>
            </div>
	   <?php } }?>
            <!-- Messages -->
            <div style="display:none" id="failure" class="notice notice-error is-dismissible">
...
//                            $totalcost = "";
                        ...
                        ?>
                            ...
                            <tr>
                                <td style="text-align:right;font-weight:bold;" align="right" colspan="8">Total Estimated Cost</td>
                                <td align="right" style="font-weight:bold;" colspan="8"><?php echo IND_money_format($totalcost) . ".00"; ?></td>
                            </tr>
                        </tbody>
                    </table>
