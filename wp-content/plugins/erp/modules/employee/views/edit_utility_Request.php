            ...
            <table class="table" border="0" id="table-utility-travel">
				...
				?>
                    <tr>
                      ...
                      <td data-title="Start Date" class="scrollmsg"><input name="txtStartDate[]" id="txtStartDate<?php echo $rows; ?>" class="erp-leave-date-field form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" value="<?php if($rowrequest->RD_StartDate=="0000-00-00") echo ""; else echo date('d-m-Y',strtotime($rowrequest->RD_StartDate)); ?>"/>
                        <input name="txtDate[]" id="txtDate<?php echo $rows; ?>" class="form-control SmallInput" placeholder="dd/mm/yyyy" style="display:none;" value="n/a"/>
                      </td>
                      <td data-title="End Date" class="scrollmsg"><input name="txtEndDate[]" id="txtEndDate<?php echo $rows; ?>" class="erp-leave-date-field form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" value="<?php if($rowrequest->RD_EndDate=="0000-00-00") echo ""; else echo date('d-m-Y',strtotime($rowrequest->RD_EndDate)); ?>"/>
                      </td>
                      <td data-title="Description"><textarea name="txtaExpdesc[]" id="txtaExpdesc1" class="form-control SmallInput" autocomplete="off"><?php echo stripslashes($rowrequest->RD_Description) ?></textarea>
                      ...
                      <td data-title="Category"><span id="modeoftr<?php echo $rows; ?>acontent">
                        <select name="selModeofTransp[]" id="selModeofTransp1" class="form-control SmallInput" onchange="setFromTo(this.value, <?php echo $rows; ?>);">
					  ...
					  ?>
                        ...
                        <select name="selStayDur[]" id="selStayDur<?php echo $rows; ?>" class="form-control SmallInput" style="display:none;">
                          <option value="n/a">Select</option>
                        </select>
                        <input type="text" class="form-control SmallInput" name="txtdist[]" id="txtdist<?php echo $rows;?>" autocomplete="off" style="display:none;" value="n/a"/>
                      </td>
                      <td data-title="Bill Number"><input type="text" name="textBillNo[]" id="textBillNo<?php echo $rows; ?>" autocomplete="off" value="<?php echo $rowrequest->RD_BillNumber;?>"  class="form-control SmallInput"/></td>
                      <td data-title="Bill Amount (Rs)"><input type="text" class="form-control SmallInput" name="txtCost[]" id="txtCost<?php echo $rows; ?>" onkeyup="valCost(this.value);" autocomplete="off" value="<?php echo $rowrequest->RD_Cost;?>"/></td>
                ...
                <div class="hidden-sm hidden-md hidden-xs" style="float:right;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-utility-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
				<div class="hidden-lg" style="float:left;  padding-top:10px; padding-bottom:10px;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-utility-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
			</div>
