...
.ui-slider .ui-slider-handle{
	...
	top: -8.1px !important;
    background:url(http://corptne.com/wp-content/plugins/erp/modules/employee/assets/css/searchSprite14.png?v=701466) no-repeat !important; overflow: hidden; 
...
<link type='text/css' rel='stylesheet' href='http://corptne.com/wp-content/plugins/erp/modules/employee/assets/css/tuxedo.v783101.css' />
<link type='text/css' rel='stylesheet' href='http://corptne.com/wp-content/plugins/erp/modules/employee/assets/css/flights_v2.v783446.css' />
<link type='text/css' rel='stylesheet' href='http://corptne.com/wp-content/plugins/erp/modules/employee/assets/css/hotels_v2.v782701.css' />
<div id="header">
...
<div class="container">
			...
			<div class="fromTo">
				...
				<div class="labl flightLogo">
					...
					<div class="onwFltLogo"> <img src="http://corptne.com/wp-content/plugins/erp/modules/employee/assets/images/hotel.png"> </div>
				
				</div>
				<div class="labl dest">
					<div class="city hotelto"><span class="code">MAA</span> Chennai</div>
    ...
    width: 22px;
"> </span><!--
					--><span class="dt"> Fri, Apr 21 2017</span>
	...
	<input type="button" class="button button-primary" data-name="show" value="Filter" id="toggle">
	</div>
</div>
</div>
...
<thead align="center" class="cf">
<tr>
<th colspan="2" width="30%" style="text-align:center;color:#000000;"><strong> Hotel Name</strong></th>
<th style="color:#000000;"><strong>Place</strong></th>
<th style="color:#000000;"><strong>Available</strong></th>
<th style="color:#000000;"><strong>PRICE</strong></th>
<th style="text-align: center;color:#000000;"><strong>Rating</strong></th>
<th style="color:#000000;"><strong>PREFERED</strong></th>
<th style="text-align: center;color:#000000;"><strong><i class="fa fa-check"></i></strong></th>
</tr>
</thead>
<tbody align="center">
...
<td><div style="width:45px;"><img style="width: 80px;height: 50px;" src="{{res.GQF_FlightNumber}}"</img><div></td>
...
<td data-title="PREFERED"><input name="cbGqfid[]" style="margin-left: 20px;" id="cbGqfid[]" type="checkbox" value="{{res.GQF_Id}}" class="checkbox"></td>
...
<img src="http://corptne.com/wp-content/plugins/erp/modules/employee/assets/images/hotel.png"> <span> No results found </span>
...
<!-- AMENITIES -->
<div data-block-type="amenity" class="block sideBlock   smartFilters vertical opened">
	
	<h5>
		<i class="dArrow showhide"></i><span class="showhide">Amenities</span>
...
<ul class="list  ">
	<li>
					<input id="1_1am24HrCheckin" type="checkbox" data-flt="am" class="filter" name="amenity" smartfilter="1" value="Front desk">
		<label for="1_1am24HrCheckin">
					<small class="fRight">{{data.amenities.Frontdesk}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon am24HrCheckin"></span>
	...
	<li>
					<input id="1_1amAC" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Free Internet">
		<label for="1_1amAC">
					<small class="fRight">{{data.amenities.FreeInternet}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amWIFI"></span>
	...
	<li>
					<input id="1_1amBar" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Laundry Service">
		<label for="1_1amBar">
					<small class="fRight">{{data.amenities.LaundryService}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amBar"></span>
	...
	<li>
					<input id="1_1amBusinessCenter" type="checkbox" data-flt="am" class="filter" name="amenity" smartfilter="1" value="Restaurant/Coffee Shop">
		<label for="1_1amBusinessCenter">
					<small class="fRight">{{data.amenities.RestaurantCoffeeShop}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amRestaurant"></span>
	...
	<li>
					<input id="1_1amCafe" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Business Services">
		<label for="1_1amCafe">
					<small class="fRight">{{data.amenities.BusinessServices}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amBusinessCenter"></span>
	...
	<li>
					<input id="1_1amGym" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Health-Spa">
		<label for="1_1amGym">
					<small class="fRight">{{data.amenities.HealthSpa}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amGym"></span>
	...
	<li>
					<input id="1_1amInternet" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Swimming Pool">
		<label for="1_1amInternet">
					<small class="fRight">{{data.amenities.SwimmingPool}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amPool"></span>
	...
	<li>
					<input id="1_1amPool" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Internet">
		<label for="1_1amPool">
					<small class="fRight">{{data.amenities.Internet}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amInternet"></span>
	...
	<li>
					<input id="1_1amRestaurant" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Parking Facility">
		<label for="1_1amRestaurant">
					<small class="fRight">{{data.amenities.ParkingFacility}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amCafe"></span>
	...
	<li>
					<input id="1_1amRoomService" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Indoor Entertainment">
		<label for="1_1amRoomService">
					<small class="fRight">{{data.amenities.IndoorEntertainment}}</small>
	...
	<li>
					<input id="1_1amWIFI" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Room Service">
		<label for="1_1amWIFI">
					<small class="fRight">{{data.amenities.RoomService}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amRoomService"></span>
	...
	<li>
					<input id="1_1amSPA" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Spa">
		<label for="1_1amSPA">
					<small class="fRight">{{data.amenities.Spa}}</small>

			<span class="span span18 truncate">

				<span class="amenitiesIcon amAC"></span>
	...
	<li>
					<input id="1_1amTA" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Travel Assistance">
		<label for="1_1amTA">
					<small class="fRight">{{data.amenities.TravelAssistance}}</small>
	...
	<li>
					<input id="1_1amOA" type="checkbox" data-flt="am" name="amenity" class="filter" smartfilter="1" value="Outdoor Activities">
		<label for="1_1amOA">
					<small class="fRight">{{data.amenities.OutdoorActivities}}</small>
