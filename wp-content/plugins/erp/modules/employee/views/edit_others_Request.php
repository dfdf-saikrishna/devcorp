            ...
            <table class="table" border="0" id="table-others-travel">
				...
				?>
                    <tr>
                      ...
                      <td data-title="Date" class="scrollmsg"><input name="txtDate[]" id="txtDate1" class="startdate form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" value="<?php if($rowrequest->RD_Dateoftravel=="0000-00-00") echo ""; else echo date('d-m-Y',strtotime($rowrequest->RD_Dateoftravel)); ?>"  />
                        <input name="txtStartDate[]" id="txtStartDate1" class="form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" style="display:none;" value="n/a" />
                        <input name="txtEndDate[]" id="txtEndDate1" class="form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" style="display:none;" value="n/a" />
                      ...
                      <td data-title="Description"><textarea name="txtaExpdesc[]" id="txtaExpdesc1" class="form-control SmallInput"><?php echo stripslashes($rowrequest->RD_Description) ?></textarea>
                      ...
                      <td data-title="Total Cost"><input name="from[]" id="city1" type="text" placeholder="From" class="form-control SmallInput" value="n/a" style="display:none;">
                        ...
                        <input type="text" class="form-control SmallInput" name="txtCost[]" id="txtCost1" onkeyup="valCost(this.value);" autocomplete="off" value="<?php echo $rowrequest->RD_Cost;?>"/></td>
                ...
                <div class="hidden-sm hidden-md hidden-xs" style="float:right;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-others-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
				<div class="hidden-lg" style="float:left;  padding-top:10px; padding-bottom:10px;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-others-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
			</div>
