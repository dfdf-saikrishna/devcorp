...
$selreq = $wpdb->get_row("SELECT * FROM requests WHERE REQ_Id=$reqid");
$limit = $selreq->Limit;
$rdidarry=array();
...
{background:#2b3244 !important; color:#fff;}
   /* Quote */	
	    ...
	    <div class="">
            <?php
            $rdidarry=array();
            $selrequest=$wpdb->get_results("SELECT * FROM request_details WHERE REQ_Id='$reqid' AND RD_Status=1");
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="flight">
                            ...
                            <div class="row" style="margin:10px 0;">
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <?php 
										if(!$rowrequest->RD_ReturnDate){ ?>
										<input type="hidden" name="flightReturn[]" class="hidereturnflight<?php echo $row; ?>" value="NULL">
										<?php } ?>
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                     <input type="text" name="to[]" id="toflight<?php echo $row; ?>" readonly class="form-control toflight" value="<?php echo $rowrequest->RD_Cityto; ?>" placeholder="To" field="<?php echo $row; ?>">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off pretraveldate flightDatefrom" readonly name="txtDate[]" value="<?php echo date('d-m-Y',strtotime($rowrequest->RD_Dateoftravel)); ?>" id="flightDatefrom<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="dd/mm/yyyy">
                                ...
                                foreach($selrgquote as $values){
									...
									if($values->RG_Pref==2)
									array_push($roundtrip, $values->GQF_Id);
        						    $hiddenPrefrdSelectedflight=join(",", $roundtrip);
                                ...
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="fileclearf">
                                <input type="hidden" id="infants<?php echo $row; ?>" name="infants" value="0">
                                <input type="hidden" name="selStayDur[]" class="fileclearf" value="NULL">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-primary getQuoteFlight" disabled id="getQuote<?php echo $row; ?>" name="getQuote" value="<?php echo $row; ?>"><i class="fa fa-search" aria-hidden="true"></i></button>
                                    ...
                                    <?php } else{ ?>
                                    <div class="col-md-1 col-sm-12 col-xs-12">
                                    <button type="button" class="btn btn-primary getQuoteFlight" disabled id="getQuote<?php echo $row; ?>" name="getQuote" value="1">Search</button>
                                    </div>
                                    <?php } ?>
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="datetohotelf">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="selStayDurf">
                        ...
                        <div class="tab-pane fade" id="bus">
                            ...
                            ?>
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                        <input type="text" placeholder="From" class="form-control frombus" readonly value="<?php echo $rowrequest->RD_Cityfrom; ?>" id="frombus<?php echo $row; ?>" name="from[]" field="<?php echo $row; ?>">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                     <input type="text" name="to[]" id="tobus<?php echo $row; ?>" readonly class="form-control tobus" value="<?php echo $rowrequest->RD_Cityto; ?>" placeholder="To" field="<?php echo $row; ?>">
                                     <label for="from" class="fa fa-map-marker" rel="tooltip" title="from"></label>
                                     </div>
                                </div>
                                </div>
                                ...
                                <input type="hidden" id="children<?php echo $row; ?>" name="children" value="0">
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="fileclearb">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="fileclearb">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <?php if($row>1){ ?>
                                    <div class="col-md-1 col-sm-12 col-xs-12 pull-right" style="padding-left: 5px; padding-right: 0px;">
                                    <button type="button" class="btn btn-primary getQuoteBus" id="getQuote" disabled name="getQuote" value="<?php echo $row; ?>"><i class="fa fa-search" aria-hidden="true"></i></button>
                                    <button type="button" class="btn btn-danger"  id="deleteRowbutton" value="<?php echo $rowrequest->RD_Id; ?>" name="deleteRowbutton" ><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                    </div>
                                    <?php } else{ ?>
                                    <div class="col-md-1 col-sm-12 col-xs-12">
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" id="children1" name="children" value="0">
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="datetohotelb">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="selStayDurb">
                                <input type="hidden" name="flightReturn[]" value="">
                                <input type="hidden" id="infants1" name="infants" value="0">
                        ...
                        <div class="tab-pane fade" id="hotel">
                            ...
                            <div class="row" style="margin:10px 0;">
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                        <input type="text" placeholder="Address" class="form-control fromhote<?php echo $row; ?>" readonly value="<?php echo $rowrequest->RD_Cityfrom;?>" id="fromhotel<?php echo $row; ?>" name="from[]" field="<?php echo $row; ?>">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                     <input class="form-control off pretraveldate hotelDatefrom" name="txtDate[]" readonly value="<?php echo date('d-m-Y',strtotime($hdeparture));?>" id="hotelDatefrom<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="Check In">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off pretraveldate hotelDateto" name="dateTohotel[]" readonly value="<?php echo date('d-m-Y',strtotime($harrival));?>" id="hotelDateto<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="Check Out">
                                            <label for="email" class="fa fa-calendar" rel="tooltip" title="email"></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" id="infants<?php echo $row; ?>" name="infants" value="0">
                                <input type="hidden" name="flightReturn[]" value="">
                                <input type="hidden" name="selStayDur[]" id="stay<?php echo $row; ?>" class="fileclearh">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-primary" id="getQuote" name="getQuote" disabled value="<?php echo $row; ?>" disabled>Search</button>
                                    </div>
                                    <?php } ?>
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" id="infants1" name="infants" value="0">
                                <input type="hidden" name="flightReturn[]" value="">
                                <input type="hidden" name="selStayDur[]" id="stay1" class="fileclearh">
                        ...
                        <div class="tab-pane fade" id="car">
                            ...
                            <div class="row" style="margin:10px 0;">
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                        <input type="text" placeholder="Pickup From" class="form-control fromcar" readonly value="<?php echo $rowrequest->RD_Cityfrom; ?>" id="fromcar<?php echo $row; ?>" name="from[]" field="<?php echo $row; ?>">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                     <input class="form-control off pretraveldate carDatefrom" name="txtDate[]" readonly id="carDatefrom<?php echo $row; ?>" value="<?php echo date('d-m-Y',strtotime($rowrequest->RD_Dateoftravel)); ?>" field="<?php echo $row; ?>" type="text" placeholder="Pickup Date">
                                     <label for="email" class="fa fa-calendar" rel="tooltip" title="email"></label>
                                     </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off time-pick carpicktime" name="pickup[]" readonly id="carpicktime1" value="<?php echo $rowrequest->pickup; ?>" field="1" type="text" placeholder="Pickup Time">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off pretraveldate carDateto" name="dateTohotel[]" readonly value="<?php echo date('d-m-Y',strtotime($rowrequest->RD_EndDate)); ?>" id="carDateto<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="Drop-off Date">
                                            <label for="email" class="fa fa-calendar" rel="tooltip" title="email"></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            <input class="form-control off time-pick cardroptime" name="dropoff[]" readonly value="<?php echo $rowrequest->dropoff; ?>" id="cardroptime<?php echo $row; ?>" field="<?php echo $row; ?>" type="text" placeholder="Drop-off Time">
                                            <label for="email" class="fa fa-clock-o" rel="tooltip" title="email"></label>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="children<?php echo $row; ?>" name="children" value="0">
								<input type="hidden" name="dateTohotel[]" value="NULL" class="fileclearc">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="fileclearc">
                                <input type="hidden" name="flightReturn[]" value="">
                                <input type="hidden" id="infants<?php echo $row; ?>" name="infants" value="0">
								...
								<div class="col-md-3 col-sm-12 col-xs-12">
                                    <textarea name="txtaExpdesc[]" id="cartxtaExpdesc1" class="form-control" readonly autocomplete="off" rows="1" cols="18" placeholder="Expense Description"><?php echo $rowrequest->RD_Description; ?></textarea>
                                </div>
                                
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                        <input class="form-control exceed-car<?php echo $row; ?> carcost" name="txtCost[]" readonly <?php echo $cstatus; ?> value="<?php echo $rowrequest->RD_Cost; ?>" id="cartxtCost<?php echo $row; ?>" autocomplete="off" onkeyup="valCostPre(this.value,<?php echo $row; ?>,3);" onchange="valCostPre(this.value,<?php echo $row; ?>,3);" type="text" placeholder="Total Cost"><span class="red" id="show-exceed-car<?php echo $row; ?>"></span>
                                        <label for="total" class="fa fa-inr" rel="tooltip" title="total"></label>
                                        </div>
                                </div>
                                </div>
                                    ...
                                    <button type="button" class="btn btn-primary btn-block" id="getQuote" disabled name="getQuote" value="<?php echo $row; ?>" disabled><i class="fa fa-search" aria-hidden="true"></i></button>
                                    <button type="button" class="btn btn-danger"  id="deleteRowbutton" value="<?php echo $rowrequest->RD_Id; ?>" name="deleteRowbutton" ><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                    </div>
                                    <?php } else{ ?>
                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                    <button type="button" class="btn btn-primary btn-block" id="getQuote" disabled name="getQuote" value="<?php echo $row; ?>" disabled>Search</button>
                                    </div>
                                    <?php } ?>
                            ...
                            <div class="row" style="margin:10px 0;">
                                ...
                                <input type="hidden" id="children1" name="children" value="0">
                                <input type="hidden" name="dateTohotel[]" value="NULL" class="datetohotelc">
                                <input type="hidden" name="selStayDur[]" value="NULL" class="selStayDurc">
                                <input type="hidden" name="flightReturn[]" value="">
                                <input type="hidden" id="infants1" name="infants" value="0">
                        ...
                        <div class="tab-pane fade in active" id="others">
                            <div class="others-rows">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
										<input type="hidden" name="dateTohotel[]" value="NULL" class="fileclearo">
										<input type="hidden" name="selStayDur[]" value="NULL" class="fileclearo">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="icon-addon addon-md">
                                            ...
                                            <input type='button' style="margin-left: 18px;" field="1" class="btn btn-primary otherfile" value="<?php _e( 'Upload Ticket', 'textdomain' ); ?>" id="uploadimage"/>&nbsp;&nbsp;<span id="otherupload1" style="display:none;"><b>Uploaded</b></span>
                                        </div>
                                    </div>
                                </div>
         ...
         <input type="hidden" value="<?php echo $limit; ?>" name="expenseLimit" id="expenseLimit"/>
         ...
         <span id="totaltable"></span>
            ...
            <table class="table" border="0" id="table-pre-travel">
				...
				?>
                    <tr>
                      ...
                      <?php } ?>
                      <td data-title="Date" class="scrollmsg"><input name="txtDate[]" <?php echo $status;?> id="txtDate<?php echo $rows; ?>" class="posttraveldate form-control SmallInput" placeholder="dd-mm-yyyy" autocomplete="off" value="<?php if($rowrequest->RD_Dateoftravel=="0000-00-00 00:00:00") echo ""; else echo date('d-m-Y',strtotime($rowrequest->RD_Dateoftravel)); ?>"  /><input name="txtStartDate[]" id="txtStartDate1" class="form-control SmallInput" placeholder="dd/mm/yyyy" autocomplete="off" style="display:none;" value="n/a" /><input name="txtEndDate[]" id="txtEndDate1" class="form-control" placeholder="dd/mm/yyyy" autocomplete="off" style="display:none;" value="n/a" />
                      <input type="text" name="textBillNo[]" id="textBillNo1" autocomplete="off"  class="form-control SmallInput" style="display:none;" value="n/a"/>
                      </td>
                      <td data-title="Description"><textarea name="txtaExpdesc[]" <?php echo $status;?> id="txtaExpdesc1" class="form-control SmallInput" autocomplete="off"><?php echo stripslashes($rowrequest->RD_Description) ?></textarea><input type="text" class="form-control" name="txtdist[]" id="txtdist1" autocomplete="off" style="display:none;" value="n/a"/></td>
                      <td data-title="Category"><select name="selExpcat[]" <?php echo $dropdown;?> id="selExpcat<?php echo $rows; ?>" class="form-control SmallInput" onchange="javascript:getMotPosttravel(this.value,<?php echo $rows; ?>)">
                          <option value="">Select</option>
                          <?php 
				  ...
				  ?>
                      ...
                      <td data-title="Category"><span id="modeoftr<?php echo $rows; ?>acontent">
                        <select <?php echo $dropdown;?> name="selModeofTransp[]" id="selModeofTransp<?php echo $rows; ?>" class="form-control SmallInput" onchange="setFromTo(this.value, <?php echo $rows; ?>);">
                          <option value="">Select</option>
                          <?php             
                      ...
                      <td data-title="City/Location"><span id="city<?php echo $rows; ?>container">
                        ...
                        <input  name="from[]" id="from<?php echo $rows; ?>" <?php echo $status;?> type="text" <?php if($rowrequest->EC_Id==2 || $rowrequest->EC_Id==4){ echo 'placeholder="Location"'; } else { echo 'placeholder="From"'; } ?> <?php if($rowrequest->MOD_Id==1) echo 'class="form-control SmallInput places"'; else echo 'class="form-control SmallInput"' ?> value="<?php echo $rowrequest->RD_Cityfrom?>"  autocomplete="off">
                        
                        
                        <input  name="to[]" id="to<?php echo $rows; ?>" <?php echo $status;?> type="text" placeholder="To" <?php if($rowrequest->MOD_Id==1) echo 'class="form-control SmallInput places"'; else echo 'class="form-control SmallInput"' ?> <?php if($rowrequest->EC_Id==2 || $rowrequest->EC_Id==4){ echo 'value="n/a" style="display:none;"'; } else { echo 'value="'.$rowrequest->RD_Cityto.'"'; } ?>  autocomplete="off">
                        <?php 
                        //echo $rowrequest['EC_Id'];
                        if($rowrequest->EC_Id==1 || $rowrequest->EC_Id==4) {
                          ?>
                        <select name="selStayDur[]" <?php echo $status;?> id="selStayDur<?php echo $rows; ?>" class="form-control SmallInput" style="display:none;">
                          <option value="n/a">Select</option>
                        </select>
                        <?php
                        }else if($rowrequest->EC_Id==2){
                        ?>
                        <select name="selStayDur[]" <?php echo $status;?> id="selStayDur<?php echo $rows; ?>" class="form-control SmallInput">
                          <option value="">Select</option>
                          <?php                     
                        ...
                        <?php } ?>
                        </span><input type="text" class="form-control SmallInput" <?php echo $status;?> name="txtdist[]" id="txtdist<?php echo $rows;?>" autocomplete="off" style="display:none;" value="n/a"/></td>
                      <td data-title="Total Cost"><input type="text" <?php echo $status;?> class="form-control SmallInput" name="txtCost[]" id="txtCost<?php echo $rows; ?>" onkeyup="valPreCost(this.value,<?php echo $rows; ?>);" onchange="valPreCost(this.value,<?php echo $rows; ?>);" autocomplete="off" value="<?php echo $rowrequest->RD_Cost;?>"/></br><span class="red" id="show-exceed<?php echo $rows; ?>"></span></td>
            ...
            <!--div style="float:right;"><a title="Add Rows" class="btn btn-default"><span id="add-row-pretravel" class="dashicons dashicons-plus-alt"></span></a><span id="removebuttoncontainer"></span></div-->
       	    <?php else: ?>
            <div class="hidden-sm hidden-md hidden-xs" style="float:right;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-posttravel-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
			<div class="hidden-lg" style="float:left;  padding-top:10px; padding-bottom:10px;"><a title="Add Rows" class="btn btn-success btn-sm"><span id="add-row-posttravel-edit">Add +</span></a> <span class="removebuttoncontainer"></span></div>
		<?php endif; ?>
	    <?php
            $a=1;
		...
		<?php else: ?>
	            ...
	            <div id="my_centered_buttons" style="margin-top:50px;">
	    ...
	    ?>
            ...
            <div class="container-fluid pgbg flight<?php echo $qrow; ?>">
               <div class="row myrow" >
                  ...
                  <div class="col-sm-4 col-md-4 col-xs-5 pt10" ><i class="fa fa-map-marker mapfa" aria-hidden="true" ></i><span class="18fnt"><span class="quote-from1"> <?php echo $rowRdDetails->RD_Cityfrom ?></span><span class="quote-to1"> - <?php echo $rowRdDetails->RD_Cityto ?> </span></span></div>
                  <div class="col-sm-4 col-md-4 col-xs-4 pt10" ><i class="fa fa-calendar mapfa" aria-hidden="true" ></i><span class="18fnt quote-date1"><?php echo date('d-m-Y',strtotime($rowRdDetails->RD_Dateoftravel));?><?php if($freturn){echo  " " ."|" . " " .  $freturn; }?></span>  </div>
               </div>
 	    ...
 	    <div id="quoteContentbus<?php echo $qrow; ?>" class="quote-row-bus">
            <div class="container-fluid pgbg bus<?php echo $qrow; ?>">
               <div class="row myrow" >
                  ...
                  <div class="col-sm-4 col-md-4 col-xs-4 pt10" ><i class="fa fa-calendar mapfa" aria-hidden="true" ></i><span class="18fnt quote-date1"><?php echo $rowRdDetails->RD_Dateoftravel;?> </span>  </div>
               </div>
