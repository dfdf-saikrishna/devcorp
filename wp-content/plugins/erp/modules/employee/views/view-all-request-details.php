            ...
            <div class="panel with-nav-tabs panel-default">
                <div class="panel-heading" style="padding: 0px; padding-top: 5px; padding-left: 5px;">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#my" data-toggle="tab"><i class="fa fa-user"></i> Pre-Travel</a></li>
                            <li><a href="#myteam" data-toggle="tab"><i class="fa fa-users"></i> Submit Bills</a></li>
                        </ul>
                </div>
	...
	<div class="postbox">
				...
				<?php
					...
					<div class="col-md-2 col-sm-12 col-xs-12">
						<a href="?page=Pre-travel&amp;tab=Pre-travel" class="btn btn-block btn-success <?php echo $active_tab == 'Pre-travel' ? 'nav-tab-active' : ''; ?>"><?php _e('Create New', 'Pre-travel'); ?></a>
					</div>
...
<!--<h3><?php _e('', 'TravelExpense'); ?><a href="?page=Pre-travel" style="float: right;" id="erp-new-designations" class="add-new-h2" data-single="1"><?php _e('Create New Request', 'erp'); ?></a></h3>-->
...
<div class="row">
		...
		?>
<div class="col-md-2 col-sm-12 col-xs-12">
<a href="?page=Post-travel&amp;tab=Post-travel" class="btn btn-block btn-success <?php echo $active_tab == 'Pre-travel' ? 'nav-tab-active' : ''; ?>"><?php _e('Create New', 'Pre-travel'); ?></a>
</div>
<div class="col-md-3 col-xs-12 pull-right">
	<form method="post">
	  <input type="hidden" name="page" value="Requests" />
	  ...
	  <div class="input-group">
		   <input type="search" id="search_id-search-input" name="sp" placeholder="Request Code" value="<?php echo $_REQUEST['sp'] ?>" class="form-control">
		   <span class="input-group-btn">
				<input type="submit" id="search-submit" class="btn btn-default" value="Search">
		   </span>
	  </div>
