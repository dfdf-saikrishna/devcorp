                            ...
                            <div id="no-more-tables">
                                <table class="wp-list-table widefat striped admins" id="table1" style="font-size:11px;">
                                    <thead class="cf">
                                        <tr>
                                            <th width="14%">Date</th>
                                            <th width="34%">Expense Description</th>
                                            <th width="26%">Expense Category</th>
                                            <th width="13%">Upload<br />
                                                bills / tickets</th>
                                    ...
                                    <tbody >
                                        ...
                                        foreach ($resql as $rowsql) {
                                            ...
                                            <tr>                                          
                                                ...
                                                <td align="center" data-title="Expenses Category"><?php echo $rowsql->MOD_Name; ?></td>
