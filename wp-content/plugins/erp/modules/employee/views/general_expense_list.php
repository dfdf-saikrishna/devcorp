...
<div class="container-fluid">
            ...
            <div class="panel with-nav-tabs panel-default">
                <div class="panel-heading" style="padding: 0px; padding-top: 5px; padding-left: 5px;">
                        <ul class="nav nav-tabs">
                            <!--li><a href="#my" data-toggle="tab"><i class="fa fa-car"></i> Mileage</a></li>
                            <!--li><a href="#myteam" data-toggle="tab"><i class="fa fa-cutlery"></i> Utility</a></li-->
                            <li><a href="#other" data-toggle="tab"><i class="fa fa-money"></i> General Expense</a></li>
                        </ul>
                </div>
	...
	?>
	<div class="row">
	<div class="col-md-2 col-sm-12 col-xs-12"><a href="/wp-admin/admin.php?page=create-others" class="btn btn-success btn-block <?php echo $active_tab == 'Pre-travel' ? 'nav-tab-active' : ''; ?>"><?php _e('Create New', 'Pre-travel'); ?></a></div>
