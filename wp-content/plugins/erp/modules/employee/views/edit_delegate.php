...
<div class="postbox">
       ...
       <div class="cols">
           <label>From</label>
           <input type="text" class="" name="txtDelegatedatefrom" id="dateFrom" onClick="this.readOnly=true" value="<?php echo $fromd;?>" parsley-required="true"/>
       </div>
       <div class="cols last">
           <label>To</label>
           <input type="text" class="" name="txtDelegatedateto" id="dateTo" value="<?php echo $tod;?>" onClick="this.readOnly=true" parsley-required="true"/>
       </div>
       </div>
       <div class="row">
