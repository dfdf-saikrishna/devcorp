...
class Scripts {
    ...
    public function register_scripts() {
        ...
        // bootstrap
        wp_register_script( 'bootstrap-js', $vendor . '/bootstrap/js/bootstrap.min.js', array( 'jquery' ), $this->version, true );
        
        wp_register_script( 'quote-req-js', $vendor . '/quote/quote-req.js', array( 'jquery' ), $this->version, true );
    }
    ...
    public function register_styles() {
        ...
        //Request Form
        wp_register_style( 'erp-req-bootstrap', $vendor . '/quote/bootstrap.css', false, $this->version );
        wp_register_style( 'erp-req-font-icon-picker', $vendor . '/quote/fontawesome-iconpicker.css', false, $this->version );
        wp_register_style( 'erp-req-icomoon', $vendor . '/quote/icomoon.css', false, $this->version );
        wp_register_style( 'erp-req-style-one', $vendor . '/quote/styles(1).css', false, $this->version );
        wp_register_style( 'erp-req-custom-one', $vendor . '/quote/custom(1).css', false, $this->version );
        wp_register_style( 'erp-req-custom-two', $vendor . '/quote/custom2.css', false, $this->version );
        wp_register_style( 'erp-req-custom-responsive', $vendor . '/quote/custom-responsive.css', false, $this->version );
        wp_register_style( 'erp-req-timepicker', '//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.css', false, $this->version );
        ...
        wp_register_style( 'material-icons', 'https://fonts.googleapis.com/icon?family=Material+Icons', 'false', '$this->version' );
        wp_register_style( 'google-font', 'https://fonts.googleapis.com/css?family=Josefin+Sans:300', 'false', '$this->version' );
        wp_register_style( 'google-font-baumans', 'https://fonts.googleapis.com/css?family=Baumans', 'false', '$this->version' );
        wp_register_style( 'erp-styles-custom', $css . '/admin-custom.css', false, $this->version );
    }
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( 'quote-req-js' );
