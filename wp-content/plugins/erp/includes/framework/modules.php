...
class Modules {
    ...
    public function init_modules() {
        $this->modules = [
            ...
            'TravelAgentClient' => [
                'title'       => __( 'TravelAgentClient', 'erp' ),
                'slug'        => 'erp-accounting',
                'description' => __( 'Travel Agent Client Functionalities', 'erp' ),
                'callback'    => '\WeDevs\ERP\Travelagentclient\Travelagentclient',
                'modules'     => apply_filters( 'erp_travelagent_client_modules', [ ] )
            ],
            'TravelAgentUser' => [
                'title'       => __( 'TravelAgentUser', 'erp' ),
                'slug'        => 'erp-accounting',
                'description' => __( 'Travel Agent User Functionalities', 'erp' ),
                'callback'    => '\WeDevs\ERP\Travelagentuser\Travelagentuser',
                'modules'     => apply_filters( 'erp_travelagent_user_modules', [ ] )
            ],
            'Traveldesk' => [
